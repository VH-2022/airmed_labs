...
<html>
    ...
    <center style="display:none;">
        ...
        <img src="https://eventerr.com/img/ajax_loader.gif"/>
        <br/>
    ...
    <form action="<?php echo $action; ?>" method="post" name="payuForm" id='payuf' class="form-horizontal" style="display:none;">
        ...
        <input type="hidden" name="surl" value="https://eventerr/com/success_payumoney" size="64" /> 
        <td colspan="3"><input name="furl" type="hidden" value="https://eventerr.com/fail_payumoney" size="64" />
        <td colspan="3"><input name="service_provider" type="hidden" value="https://eventerr.com//success_payumoney/" size="64" /><input type="hidden" name="service_provider" value="payu_paisa" size="64" />
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <input name="amount"  value="2.00" readonly  />
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <input name="firstname"  id="firstname" value="ccccc" readonly  />
                </div>
            </div>
            <div class="control-group">
                ...
                <div class="controls">
<?php /*             <input name="email" id="email" value="<?php echo $user_detail[0]['email']; ?>"  readonly  />
        */ ?>
        
                    <input name="email" id="email" value="payment@airmedlabs.com"  readonly  />
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <?php /* <input name="phone"  value="<?php echo $user_detail[0]['mobile']; ?>" readonly   />*/?>
                    <input name="phone"  value="7434877700" readonly   />
                </div>
            </div>
