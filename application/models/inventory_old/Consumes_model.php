...
Class Consumes_model extends CI_Model {
    ...
    public function getitem_num($srchdata = null) {
        ...
        $query = $this->db->query("SELECT it.*,bm.brand_name from inventory_item as it LEFT JOIN inventory_brand as bm on bm.id = it.brand_fk and bm.status='1' WHERE it.status ='1' and it.category_fk='2' $temp");
