<?php
Class Dr_assign_model extends CI_Model { 
     public function num_row($branchid, $email = null) {
        $query = "select sr.*,br.branch_name from send_report_for_approve as sr LEFT JOIN branch_master as br on br.id= sr.branch_fk and br.status='1' where sr.status='1'";
        if ($branchid != NULL) {
