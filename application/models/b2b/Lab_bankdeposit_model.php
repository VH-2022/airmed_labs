...
class Lab_bankdeposit_model extends CI_Model {
    ...
    public function lab_num_rows($state_serch = null, $bank = null,$lab_name = null,$laball=null){
        ...
        if ($bank != "") {
         ...
         if ($lab_name != "") {
            ...
            $query .= " AND collect_from.name like '%$lab_name%'";
        }
		if($laball != ""){
			$query .= " AND lab_bankdetail.lab_fk in($laball)";
		}
    ...
    public function lab_data($state_serch = null, $bank = null,$lab_name =null ,$limit, $start,$laball=null) {
