                    ...
                    <div class="col-md-4">
                        <div class="box box-solid" style="background:#EEE;">
                            <div class="box-header with-border">
                                ...
                                <a href="<?= base_url(); ?>inventory/Test_item/delete/<?= $id ?>/<?= $key["machine_fk"] ?>" onclick="return confirm('Are you sure?');" class="pull-right"><i class="fa fa-trash"></i></a>
                            </div><!-- /.box-header -->
                            <div class="box-body">
                                <ul>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="recipient-name" class="form-control-label">Select Machine:</label>
                    <select class="chosen chosen-select" name="machine" id="machine_id_edit" onchange="machine_select_edit();">
                        <option value="">--Select--</option>
                        <?php
                        foreach ($machine_details as $mkey) {
                            ?>
...
<script>
    ...
    function machine_select_edit() {
        ...
        if (selected_ids != '') {
            ...
            $("#items_list_edit").attr("style", "display:none;");
            //$(".chosen").val('').trigger("liszt:updated");
        }
