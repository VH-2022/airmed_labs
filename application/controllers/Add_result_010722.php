...
//                }
    ...
    function approve_reporttest_whatsapp($id) {
        ...
        if ($testfk != null) {
			...
			$feedbackurl = "https://airmedlabs.com/feedback?pid=". $id ."&cid=1";
            ...
            "parameters": "[{\'name\':\'pname\', \'value\':\''. $patient_name .'\'}, {\'name\':\'pdfLink\', \'value\':\'https://airmedlabs.com/upload/report/' . $name . '\' }, {\'name\':\'labid\', \'value\':\''. $id .'\'}, {\'name\':\'regdate\', \'value\':\'' . date("d-M-Y", strtotime($data["query"][0]['regi_date']))  . '\'}, {\'name\':\'feedbacklink\', \'value\':\''. $feedbackurl . '\' } ]"
            }',
