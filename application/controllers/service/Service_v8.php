...
/// ---------for half payment add_job --
    ...
    function health_feed() {
        ...
        /* Check api version */
        $check_version_array = array("android" => array("version" => "402", "compulsory" => "no", "message" => "New version available please update it and enjoy new feature."), "ios" => array("version" => "2", "compulsory" => "no", "message" => "New version available please update it and enjoy new feature."));
