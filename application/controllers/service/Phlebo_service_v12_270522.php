...
//        exit;
	...
	function phlebo_punches() {
        $punches = $this->service_model->get_val("select pt.id, pt.user_fk, pt.time 'attendedtime', pt.start_date, pt.start_time, pt.stop_date, pt.stop_time, pm.name, pm.empcode from phlabo_timer pt inner join phlebo_master pm on pt.user_fk = pm.id ");
		//echo '<pre>';
