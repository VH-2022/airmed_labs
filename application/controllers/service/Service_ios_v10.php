  ...
  WHERE `package_master`.`status` = '1' 
    ...
    function job_report1() {
        ...
        if ($jid != null) {
            ...
            $data[0]["final_total"] = "0";// . $final_total;
...
/// ---------for half payment add_job --
    ...
    function health_feed() {
        ...
        /* Check api version */
        $check_version_array = array("android" => array("version" => "40", "compulsory" => "yes", "message" => "New version available please update it and enjoy new feature."), "ios" => array("version" => "2", "compulsory" => "yes", "message" => "New version available please update it and enjoy new feature."));
        ...
        if ($uid != NULL && $select_tests != Null && $total != Null) {
            ...
            if ($emergency_req == "true") {
                ...
                if ($total >0) {
					...
					$collectioncharge_amount = 100;
					$j_total_price = $j_total_price + $collectioncharge_amount;
                    $total = $total + $collectioncharge_amount;                    
                }
                /* collection charge end */
...
' . $payfrom_wallet . '
    ...
    function home_page() {
        ...
        /* Check api version */
        $check_version_array = array("android" => array("version" => "55", "compulsory" => "yes", "message" => "New version available please update it and enjoy new feature."), "ios" => array("version" => "1.3.13", "compulsory" => "no", "message" => "New version available please update it and enjoy new feature."));
