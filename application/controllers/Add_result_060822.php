...
//                }
    ...
    function approve_reporttest_whatsapp($id) {
        ...
        if ($testfk != null) {
            ...
            $patient_mob = $data['query'][0]["mobile"];			$patient_mob = str_replace(" ","", $patient_mob);
            ...
            "parameters": "[{\'name\':\'pname\', \'value\':\''. $patient_name .'\'},{\'name\':\'pdfLink\', \'value\':\'http://airmedlabs.com/upload/report/' . $name . '\' },{\'name\':\'labid\', \'value\':\''. $id .'\'},{\'name\':\'regdate\', \'value\':\''. date("d-M-Y", strtotime($data["query"][0]['regi_date']))  .'\'}]"
            }',
