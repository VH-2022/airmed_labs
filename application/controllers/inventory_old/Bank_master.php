...
class Bank_master extends CI_Controller {
   ...
   function bank_list() { 
        ...
        if ($bank_name !='' || $branch_name !='' || $account_no !='' ||   $city !='') { 
             $srchdata = array("bank_name"=>$bank_name,"branch_name"=>$branch_name,"account_no"=>$account_no,"city"=>$city);
            ...
            $config = array();
            /* Vishal Code Start */
            $config["base_url"] = base_url() . "inventory/bank_master/bank_list?bank_name=$bank_name&branch_name=$branch_name&account_no=$account_no&city=$city";
