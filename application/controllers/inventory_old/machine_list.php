                                ...
                                <tbody>
                                    ...
                                    foreach ($final_array as $row) {
                                        ...
                                        <tr> <td><?php echo $cnt; ?></td>
                                            ...
                                            <td><?php echo ucwords($row['assign_branch'][0]["branch"]); ?></td>
                                            <td><a href='<?php echo base_url(); ?>inventory/machine/machine_edit/<?php echo $row['id']; ?>' data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-edit"></i></a> 
