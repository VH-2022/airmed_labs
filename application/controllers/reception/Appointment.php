...
class Appointment extends CI_Controller {
    ...
    public function index() {
        ...
        if ($this->form_validation->run() != FALSE) {
            ...
            redirect("reception/appointment?startdate=" . date("d-m-Y") . "&end_date=" . date("d-m-Y") . "");
        } else {
            ...
            $config = array();
            $config["base_url"] = base_url() . "reception/appointment?startdate=$start_date&end_date=$end_date";
