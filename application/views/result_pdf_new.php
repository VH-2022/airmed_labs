           ...
           if (!isset($departmentIndex[$dept])) {
            ...
            if (!empty($testidp[0]["parameter"]) || $testidp['report_type'] == 2) {
                ...
                if ($parameter_val_cnt != 0) {
                    ?>
                    <?php
                    if ($cnt != 0 && ($testidp["on_new_page"] == 1 || $department_name != $testidp["department_name"])) {
                        $department_name = "";
                        ?>
                        <?php
                        $pageStart = true;
                                        ...
                                        if (!empty($parameter['parameter_name']) && !empty($parameter['user_val'])) {
                                            ...
                                            <tr style="font-size: 11px;">
                                                <td valign="top" style="width: 30%;font-size: 12px;"><?php
                                                    ...
                                                    $finalpageArray[$pagecount - 1]["department"] = $testidp["department_name"];
                ...
                if ($pageStart) {
                    $pagecount++;
                    $finalpageArray[] = array("page" => "chapter" . $pagecount , "sample_type" => array(),'departmentCount'=>$departmentCount);
                    $currentpage = $pagecount - 1;
                    ?> <div class="chapter<?= $pagecount ?>" >
                    <?php
                    $pageStart = false;
