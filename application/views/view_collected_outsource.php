        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                        ...
                        <?php echo form_open_multipart("add_result/add_value_outsource", array("id" => "add_result", "method" => "post")); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        ?>><?php echo $parameter['parameter_name']; ?></td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <input type="text" class="number" tabindex="<?php echo $tabindex++; ?>" style="width:83%;float: left;" formula="<?php echo ( $parameter['formula'] != "") ? "true" : "false"; ?>" name="parameter_value_<?php echo $cnt; ?>" onkeyup="DelayedCallMe(200, '<?= $cnnt ?>', '<?php echo $parameter['id']; ?>');" id="<?= $cnnt ?>_<?php echo $parameter['id']; ?>" value="<?= $parameter['user_val'][0]["value"]; ?>">
...
<?php echo $closeFancyBox[0]; ?>
    ...
    function change_order() {
        $("#add_result").attr("action", "<?php echo base_url(); ?>add_result/change_order_outsource");
        setTimeout(function () {
            $("#add_result").submit();
        }, 500);
    }
