...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Edit Branch Package Discount</li>
    </ol>
</section>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" action="<?php echo base_url(); ?>Branch_Package_Discount/edit/<?php echo $cid; ?>" method="post" enctype="multipart/form-data" id="test_submit">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="branch_data" id="branch_data" class="form-control">
                                    <option value="">--Select--</option>
                                    <?php foreach ($test_branch as $key) {
                                        ?>
                                        <option value="<?php echo $key['id'] ?>" <?php
                                        if ($key['id'] == $query[0]['branch']) {
                                            echo "Selected";
                                        }
                            ...
                            <div class="form-group">
                                <label for="exampleInputFile">How many days active package available from user booking?</label>
                                <input type="text" name="package_active_user_book" class="form-control"  value="<?php echo $query[0]['package_active_user_book']; ?>" id="package_active_user_book" onkeyup="calculate_age1(this.value)">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="active_till_date" class="form-control" value="<?php echo date("Y-m-d", strtotime($query[0]['active_till_date'])); ?>" id="active_till_date" onchange="changeDate(this.value)">
                            </div>

                            <div class="form-group">
                                <label for="exampleInputFile">Other Test Discount For Self (%)</label><span style="color:red">*</span>
                                <input type="text" name="other_test_discount_self" id="other_test_discount_self" class="form-control"  value="<?php echo $query[0]['other_test_discount_self']; ?>" id="other_test_discount_self">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="other_test_discount_family" id="other_test_discount_family" class="form-control"  value="<?php echo $query[0]['other_test_discount_family']; ?>" id="other_test_discount_family">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="test_data" id="test_data" class="form-control" onchange="get_test_price()">
                                    <option value="">--Select--</option>
                                    <?php foreach ($test_master as $key) {
                                        ?>
                                        <option value="<?php echo $key['id'] ?>"> <?php echo $key['test_name'] ?> </option>
                                    <?php } ?>
                                </select>
                            </div>
                            ...
                            <table class="table table-striped" id="city_wiae_price">
                                ...
                                <tbody id="t_body">
                                    ...
                                    foreach ($price as $p) {
                                        ?>
                                        <tr id="<?= $p['id'] ?>"><td><?= $p['test_name'] ?></td><td><input type="text" name="price[]" class="price" id="price_<?= $p['branch_id'] ?>" value="<?php echo $p['discount'] ?>">%<br/><span id="price_error_<?= $p['branch_id'] ?>" class="errorall" style="color:red;"></span><input type="hidden" name="branch_fk[]" value="<?= $p['branch_id'] ?>"></td><td><a href="javascript:void(0);" onclick="delete_city_price('<?php echo $p['id'] ?>', '<?php echo $p['test_name'] ?>')"><span class="glyphicon glyphicon-trash"></span></a></td></tr>
                                    <?php }
                                    ?>
                                </tbody>
                            </table>
