                ...
                <tr>
                    <td style="width:65%; margin-bottom:25px;">
                        <table style="margin-left:20px">
                            ...
                            <tr>
                                <td colspan="2" style="font-family: 'Roboto', sans-serif;"><?= ucwords($branchdetils[0]["branch_name"]); ?></td>
                            </tr>
                            <tr>
                                <td colspan="2" style="font-family: 'Roboto', sans-serif;"><?= ucwords($branchdetils[0]["address"]); ?></td>
                            </tr>
                        ...
                        <table style="border-spacing:0;width:260px;margin-left:0px;">
                            ...
                            <tr>
                                ...
                                <td class="last" style="border-top:1px solid #000;border-right:1px solid #000;padding:5px;font-size:12px;font-weight:700;font-family: 'Roboto', sans-serif;">
                                   <?php if($date2){ ?>  <b><?= "AIRTECH-".$branchdetils[0]["id"]."-".date('m-Y',strtotime($date2)); ?></b> <?php } ?>
                                </td>
                            </tr>
                            <tr>
                                <td class="last" style="border-top:1px solid #000;border-left:1px solid #000;border-right:1px solid #000;padding:5px;font-size:12px;font-weight:700;font-family: 'Roboto', sans-serif;">
				...
				<tr>
				  <td colspan="2">
						 <table class="" style="width:94%;border:1px solid #000; border-spacing: 0;margin:0 auto;">
                                ...
                                <tbody>
                                    <tr height="50">
                                        <td style="width:80%;border-bottom:0px solid #000;font-size:16px;text-align:left;padding:3px 10px;font-family:'Roboto', sans-serif">Total Gross</td>
                                        <td style="width:20%;border-left:0px solid #000;border-bottom:0px solid #000;font-size:14px;text-align:center;padding:3px 10px;font-family:'Roboto', sans-serif "><?= $revenue ?></td>
                                    </tr>
									<tr>
                                        <td style="width:80%;border-bottom:1px solid #000;font-size:16px;text-align:left;padding:3px 10px;font-family:'Roboto', sans-serif">Monthly fee(%)</td>
                                        <td style="width:20%;border-left:0px solid #000;border-bottom:1px solid #000;font-size:14px;text-align:center;padding:3px 10px;font-family:'Roboto', sans-serif "> 7 %</td>
                                    </tr>
									
									 <tr>
                                        <td style="width:80%;border-bottom:1px solid #000;font-size:16px;text-align:left;padding:3px 10px;font-family:'Roboto', sans-serif"><b>Net Revenue</b></td>
                                        <td style="width:20%;border-left:1px solid #000;border-bottom:1px solid #000;font-size:14px;text-align:center;padding:3px 10px;font-family:'Roboto', sans-serif "><b>Rs.<?= $payamount; ?></b></td>
                                    </tr>
									<tr>
                                        <td colspan='2' style="width:80%;border-bottom:1px solid #000;font-size:16px;text-align:left;padding:3px 10px;font-family:'Roboto', sans-serif"><?= $amountsring ?></td>
