...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url(); ?>test_method/index"><i class="fa fa-users"></i>Test Method List</a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" action="<?php echo base_url(); ?>test_method/edit/<?php echo $cid ?>" method="post" enctype="multipart/form-data" id="test_submit">
                    <div class="box-body">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="exampleInputFile">Method</label><span style="color:red">*</span>
                                <input type="text" name="test_method" class="form-control"  value="<?php echo $query[0]['method']; ?>" id="test_method">
                                <span id="test_methoderror" class="errorall" style="color:red;"><?= form_error('test_method'); ?></span>
                            </div>
                        </div>
...
<script>
    ...
    $("#test_submit").submit(function (e) {
        ...
        var test_method = $("#test_method").val().trim();
        ...
        if (test_method == "") {
            error = 0;
            $("#test_methoderror").html("The Test Method field is required.");
        }
