...
<?php if ($login_data['type'] == 1 || $login_data['type'] == 2 || $login_data['type'] == 5 || strtolower($login_data['email']) == "shyamlab@airmedlabs.com" || strtolower($login_data['email']) == "krishnalabkaalol@gmail.com" || strtolower($login_data['email']) == "krishnalabkaalol@gmail.com") { ?>
                                        $("#test_" + job_fk + "_" + tst_fk).attr("onclick", "approveTest('" + job_fk + "','" + tst_fk + "')");
                                        $("#test_" + job_fk + "_" + tst_fk).attr("class", "text_highlight");
                                        $("#btn_" + job_fk + "_" + tst_fk).attr("style", "");
