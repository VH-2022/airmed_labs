        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-6">
                        <!-- form start -->
                        <form role="form" action="<?php echo base_url(); ?>bill_master/bill_add" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="name">Invoice No</label><span style="color:red">*</span>
                                <input type="text" id="invoice_no" name="invoice_no" class="form-control" value="<?php echo set_value('invoice_no'); ?>"/>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="date1" name="last_date" class="form-control datepicker-input" readonly="" value="<?php echo set_value('last_date'); ?>"/>
