        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="panel panel-primary" style="border-color:#bf2d37;">
                    ...
                    <form role="form" id="department_form" action="<?php echo base_url(); ?>hrm/Salary_structure/edit/<?php echo $cid; ?>" method="post" enctype="multipart/form-data">
                        <div class="panel-body">

                            <div class="form-group col-sm-8">
                                <label for="exampleInputFile" class="col-sm-3 pdng_0">Salary Structure Name </label>
                                <div class="col-sm-9 pdng_0">
                                    <input type="text" id="salary_stru_name" name="salary_stru_name" placeholder="Salary Structure Name" value="<?php echo $query->salary_strucure_name; ?>" class="form-control"/>
                            ...
                            <div class="col-md-8">
                                <table id="example4" class="table table-bordered table-striped">
                                    ...
                                    <tbody id="table_body1">
                                        ...
                                        $count1 = 0;
                                        $readonly = "";
                                        foreach ($master_details as $ms) {
                                            ?>
                                            <tr id="tr_<?= ++$count1 ?>">
                                                <td>
                                                    <a href="javascript:void(0)" onclick="row_remove('<?= $count1++ ?>');"><i style="color:red;" class="fa fa-minus-square"></i></a>
                                                </td>
                                                <td>
                                                    <input type="text"name="salary_name_1[]" placeholder="value" id="salary_name_1_0" class="form-control pricevalue" value="<?php echo $ms->salary_name ?>">
                                                ...
                                                <td>
                                                    <input type="text" name="salary_value[]" placeholder="value" id="pricevalue_1" class="form-control pricevalue" value="<?php echo $ms->value ?>">
                                                </td>
                                                <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="salary_name_1[]" placeholder="value" id="salary_name_1_0" class="form-control pricevalue">
                                                <span id="salary_name_1_error_0" style="color:red;"></span>
                                            </td>
                                            <td>
                                                <select name="cuttype[]" class="form-control" id="">
                                            ...
                                            <td>
                                                <input type="text" name="salary_value[]" placeholder="value" id="pricevalue_1" class="form-control pricevalue">
                                            </td>
                                            <td>
                                                <select name="type[]" class="form-control">
                        ...
                        <div class="panel-footer">
                            <button class="btn btn-primary" type="button" onclick="submit_button1();">Update</button>
                        </div>
                    </form>
                </div><!-- /.box -->
            </div><!-- /.col -->
