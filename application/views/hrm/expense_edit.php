        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-primary" style="border-color:#bf2d37;">
                    ...
                    <form role="form" id="expense_form" action="<?php echo base_url(); ?>hrm/expense/edit/<?php echo $cid; ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <div class="form-group col-sm-12  pdng_0">
                                    ...
                                    <div class="col-sm-6 pdng_0">
                                        <input type="text" id="name" name="name" placeholder="Item Name" class="form-control" value="<?php echo $query->item_name; ?>"/>
                                ...
                                <div class="form-group col-sm-12  pdng_0">
                                    ...
                                    <div class="col-sm-6 pdng_0">
                                        <input type="text" id="from" name="from" placeholder="Purchase From" class="form-control" value="<?php echo $query->purchase_from; ?>"/>
                                ...
                                <div class="form-group col-sm-12  pdng_0">
                                    ...
                                    <div class="col-sm-6 pdng_0">
                                        <input type="text" id="date" name="date" placeholder="Purchase Date" class="datepicker-input form-control" value="<?php echo $query->purchase_date; ?>"/>
                                ...
                                <div class="form-group col-sm-12  pdng_0">
                                    ...
                                    <div class="col-sm-6 pdng_0">
                                        <input type="text" id="amount" name="amount" placeholder="Price of Item" class="form-control" value="<?php echo $query->amount; ?>"/>
                                ...
                                <div class="form-group col-sm-12  pdng_0">
                                    ...
                                    <div class="col-sm-6 pdng_0">
                                        <a href="<?php echo base_url(); ?>upload/employee/<?php echo $query->bill; ?>" target="_blank"><?php echo $query->bill; ?></a><br>
