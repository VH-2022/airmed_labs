...
<div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-primary" style="border-color:#bf2d37;">
                    ...
                    <form role="form" id="award_form" action="<?php echo base_url(); ?>hrm/award/edit/<?php echo $cid; ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <div class="form-group col-sm-12  pdng_0">
                                    ...
                                    <div class="col-sm-6 pdng_0">
                                        <input type="text" id="name" name="name" placeholder="Award Name" class="form-control" value="<?php echo $query->name; ?>"/>
                                ...
                                <div class="form-group col-sm-12  pdng_0">
                                    ...
                                    <div class="col-sm-6 pdng_0">
                                        <input type="text" id="gift" name="gift" placeholder="Gift" class="form-control" value="<?php echo $query->gift_item; ?>"/>
                                ...
                                <div class="form-group col-sm-12  pdng_0">
                                    ...
                                    <div class="col-sm-6 pdng_0">
                                        <input type="text" id="cash" name="cash" placeholder="Cash Price" class="form-control" value="<?php echo $query->cash_price; ?>"/>
                                    ...
                                    <div class="col-sm-6 pdng_0">
                                        <select id="employee_id" class="chosen-select" name="employee_id">
                                            ...
                                            <?php foreach ($employee_list as $employee) { ?>
                                                <option value="<?php echo $employee->employee_id; ?>" <?php if($query->employee_id == $employee->employee_id) { echo "selected"; } ?>><?php echo ucwords($employee->name) . " (EmpID: " . $employee->employee_id . ")"; ?></option>
                                            <?php } ?>
                                        </select>
    ...
    <!--                                        <select class="chosen-select">
                                            ...
                                            <input type="text" class="month form-control" name="month" id="month" value="<?php echo $query->for_the_month; ?>" placeholder="Month">
                                            <span style="color:red;"><?php echo form_error('month'); ?></span>
                                        </div>
                                        <div class="col-sm-2 pdng_0">
                                        </div>
                                        <div class="col-sm-5 pdng_0">
                                            <input type="text" class="year form-control" name="year" id="year" value="<?php echo $query->for_the_year; ?>" placeholder="Year">
