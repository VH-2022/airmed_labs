...
<!--                            <a href="javascript:void(0);" class="btn btn-sm btn-primary">Export CSV</a>-->
                        ...
                        <div class="col-sm-12">
                            <?php
                            echo "<h3>" . date("F", mktime(0, 0, 0, $_GET['month'], 10)) . " " . date('Y') . "</h3>";
                            ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <small><b>Sample Formate</b>&nbsp; (Sr. No., Employee Code, Name of Employee, No. of Leaves, Over Time, Petrol, Incentive, Sunday Wages, Festival Allowance, Others Earning, TDS, MAINTENACE COST, Working Hours, Other Deduction,PT)</small>
                </div>
...
<script>
    $("#search_btn").click(function () {
        ...
        var city = $("#city").val();
        window.location = "leave_list?employee=" + emp_val + "&month=" + month_val + "&current_year=<?= date('Y') ?>&city=" + city;
    });
</script>
<script>
    $(function () {
