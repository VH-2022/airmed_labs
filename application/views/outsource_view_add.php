...
<section class="content-header">
    <h1>
        Outsource Test <?= ucfirst($test_info[0]["name"]); ?>
        <small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo base_url(); ?>home"><i class="fa fa-dashboard"></i>Dashboard</a></li>
        <li><a href="<?php echo base_url(); ?>outsource_master/outsource_list">Outsource List</a></li>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <p class="help-block" style="color:red;"><?php
                    ...
                    ?></p>
                <!-- form start -->
                <a style="float:right;margin-right:500px;" data-toggle="modal"  data-target="#import" class="btn btn-success btn-sm" > Import</a>
                <a href="<?php echo base_url(); ?>outsource_master/export_outsourcetest/<?= $tid ?>/<?php echo $cid; ?>" style="float:right;margin-right:5px;"  class="btn btn-success btn-sm" >Export</a>
                <form role="form" action="<?php echo base_url(); ?>outsource_master/outsource_view_add/<?= $tid ?>/<?php echo $cid; ?>" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="exampleInputFile">Outsource Name:</label>
                                <span><?php echo $outsource_name; ?></span>
                            </div>

                            <div class="form-group">
                                <label for="exampleInputFile">Test</label><span style="color:red;">*</span>
                                <select class="chosen chosen-select" data-live-search="true" name="test_fk" id="testlist" data-placeholder="Select Test" value="<?php echo set_value('price'); ?>">
                                    <?php echo $test_pack; ?>
                                </select>
                            ...
                            <div class="form-group">
                                <label for="exampleInputFile">TAT</label><span style="color:red;">*</span>
                                <input type="text" name="tat" class="form-control" value="<?php echo set_value('tat'); ?>" onkeypress="return event.charCode &gt;= 48 &amp;&amp; event.charCode &lt;= 57" />
                                <span style="color: red;"><?= form_error('tat'); ?></span>
                            </div>
                            <!--div class="form-group">
                                <label for="exampleInputFile">Test Code</label>
                                <input type="text" name="test_code" class="form-control" value="<?php echo set_value('test_code'); ?>" />
                                <span style="color: red;"><?= form_error('test_code'); ?></span>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputFile">Sample Type</label>
                                <input type="text" name="sample_type" class="form-control" value="<?php echo set_value('sample_type'); ?>" />
                                <span style="color: red;"><?= form_error('sample_type'); ?></span>
                            </div-->
                            <div class="form-group">                               
                                <div class="form-group">
                                    <button class="btn btn-primary btn-md" style="margin-top:10px;float: right;" type="submit">ADD</button>
                                    <a class="btn btn-primary" style="margin-right:15px;margin-top:10px;float: right;" href="<?= base_url() . "outsource_master/outsource_list"; ?>">Back</a><br/><br/><br/>
                                </div>
                            </div>
                            <?php
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:10%;">TAT(Hours)</th>
                                ...
                                <tbody>
                                    <?php foreach ($sub_test as $key) { ?>
                                        <tr>
                                            ...
                                            <td><?= ucfirst($key["test_code"]); ?></td>
                                            <td><?= ucfirst($key["sample"]); ?></td>
                                            <td><?= ucfirst("Rs." . $key["price"]); ?></td>
                                            <td><?= ucfirst($key["tat"]); ?></td>
                                            <td><a href="<?= base_url(); ?>outsource_master/outsource_view_delete/<?= $key["id"] ?>/<?php echo $city; ?>" onclick="return confirm('Are you sure?');" class="btn btn-danger">Delete</a></td>
                                        </tr> 
                                    <?php } ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php echo form_open_multipart('Outsource_master/import_outtest/' . $tid . '/' . $cid, $attributes); ?>
...
<script type="text/javascript" src="<?php echo base_url(); ?>user_assets/chosen-selectn/chosen.jquery.js"></script>
