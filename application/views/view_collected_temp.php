...
<?php echo "START_1111-".date("Y-m-d H:i:sa"); ?>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                        ...
                        <?php echo form_open_multipart("add_result/add_value_exists", array("id" => "add_result", "method" => "post")); ?>
...
<?php echo "END_222-".date("Y-m-d H:i:sa"); ?>
<script>
