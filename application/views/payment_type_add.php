            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="col-md-6">
                        ...
                        <!-- form start -->
                        <?php
                        echo form_open_multipart('Payment_type/add', ['method' => 'post', 'class' => 'form-horizontal',
                            'id' => 'target', 'enctype' => 'multipart/form-data']);
                        ?>
                        <div class="form-group">
                            <label for="start_time"> Name</label><span style="color:red">*</span>
                            <?php echo form_input(['name' => 'name', 'class' => 'form-control', 'placeholder' => 'Unit Name', 'value' => set_value('name')]); ?>
