        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-6">
                        <!-- form start -->
                        <form role="form" action="<?php echo base_url(); ?>inventory/Tax_master/add" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <select name="city_fk" class="form-control">
                                    ...
                                    <option value="<?php echo $val['city_fk'];?>"><?php echo $val['name'];?></option>
