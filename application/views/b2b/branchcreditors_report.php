        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <a href="<?=base_url();?>b2b/logistic/branchcreditors_csv/<?= $bid."/".$cid."?start_date=".$start_date."&end_date=".$end_date; ?>" class="btn btn-primary btn-sm pull-right">Export CSV</a>
                        <div class="widget">
                        ...
                        <!-- Search start-->
                        <?php /* echo form_open("report_master/branchcreditors/".$bid."/".$cid, array("method" => "GET", "role" => "form")); ?>
                        <div class="row">
                            <div class="col-sm-2">
                                        ...
                                        foreach ($view_all_data as $am_br) {
                                            if (empty($am_br["paid_by"])) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo base_url(); ?>b2b/logistic/details/<?php echo $am_br['barcode_fk']; ?>" target="_blank"><?php echo $am_br['patient_name']; ?>&nbsp;&nbsp;(<?php echo $am_br['order_id']; ?>)</a></td>
        <!--                                                <td><?php
                                                    if ($am_br['credit'] != "") {
