...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Add CLient Print Permission </li>
    </ol>
...
<section class="content">
 ...
 <?php if ($this->session->flashdata('duplicate')) { ?>
                            ...
                            <?php } ?>
                <!-- form start -->
                <form role="form" action="<?php echo base_url(); ?>b2b/Sample_print_master/sub_sample_add" method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        <div class="col-md-6">
                          <div class="form-group">
							   ...
							   <?php foreach($client  as $bra){ ?>
							    
							   <option value="<?= $bra['id']; ?>"  <?php echo set_select('client_fk',$bra['id']); ?> ><?= $bra['name']; ?></option>
							   <?php } ?>
							   </select>
                            ...
                            <div class="form-group">
                               ...
                               <input type="checkbox" name="print_report">
                            </div>
