            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header">
                        ...
                        <a style="float:right;" href='<?php echo base_url(); ?>b2b/Creditors_master/add' class="btn btn-primary btn-sm" ><i class="fa fa-plus-circle" ></i><strong > Add</strong></a>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <div class="widget">
                        ...
                        <div class="tableclass">
                            <form role="form" action="<?php echo base_url(); ?>b2b/Creditors_master/" method="get" enctype="multipart/form-data">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($query as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href='<?php echo base_url(); ?>b2b/Creditors_master/edit/<?php echo $row->id; ?>' data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-edit"></i></a> 
                                                    <a  href='<?php echo base_url(); ?>b2b/Creditors_master/delete/<?php echo $row->id; ?>' data-toggle="tooltip" data-original-title="Remove" onclick="return confirm('Are you sure you want to remove this data?');"><i class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                            $cnt++;
