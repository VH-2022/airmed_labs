<html><head>
		...
		<div class="pdf_container">
			...
			<table style="border-left:6px solid #E30026;width:100%;">
			   ...
			   <tr>
                    <td colspan="2"><center><h1 style="font-weight:bold;font-size:22px;text-align:center;text-transform:uppercase;font-family:'Roboto', sans-serif;">Payment Receipt</h1></center></td>
			 </tr>
				<tr>
					<td colspan="2">
							<table>
                    ...
                    <td style="width:35%;margin-bottom:15px;float:left;">
                        <table style="border-spacing:0;width:260px;margin-left:0px;">
                            ...
                            <tr>
                                ...
                                <td class="last" style="border-top:1px solid #000;border-right:1px solid #000;border-left:1px solid #000;padding:5px;font-size:12px;font-weight:700;border-bottom:1px solid #000;font-family: 'Roboto', sans-serif;">
                                    <b><?= date("jS M Y",strtotime($date2)); ?></b>
                                </td>
                            </tr>
				...
				<tr>
				  <td colspan="2">
						 <table class="" style="width:94%;border:1px solid #000; border-spacing: 0;margin:0 auto;">
                                ...
                                <tbody>
                                    <tr>
                                        <td  colspan="2" style=" #000;font-size:14px;text-align:left;padding:3px 10px; font-family:'Roboto', sans-serif;height:50px;vertical-align:top;"><?= ucwords($payrecipt->note); ?></td>                   
			...
			<table style="border-spacing: 0;margin-left: 4.2%;margin-top: -4px;   width: 96.5%;">
                                    ...
                                    <tr>                                        <td style="border-bottom:1px solid #000;border-left:1px solid #000; font-size:14px;text-align:left;padding:3px 10px;font-family:'Roboto', sans-serif;width:61.5%;"><b>Total :</b></td>
                                        ...
                                        <td style="width:2%;border-left:1px solid #000;border-bottom:1px solid #000;border-right:1px solid #000;font-size:14px; text-align:center;padding:3px 10px;font-family:'Roboto', sans-serif"><b><?= "Rs.".round($payrecipt->amount); ?></b></td>                   
                                    </tr>
                                  <?php  /* <tr>
                    ...
                    <div class="testreport_full">	
                        ...
                        <div class="full_div">
							 ...
							 <table style="width:100%;margin-bottom:100px;">
							  <tr>
									<td colspan="2">
									<b style="font-family:'Roboto', sans-serif;font-size:12px;">COMPUTER GENERATED Payment Receipt,REQUIRES NO SIGNATURE</b>
									</td>
								</tr>
							</table>
