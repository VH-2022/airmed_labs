...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url(); ?>Creditors_master/Creditors_list"><i class="fa fa-users"></i>Creditors List</a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" action="<?php echo base_url(); ?>b2b/Creditors_master/edit/<?= $uid ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  name="mobile" class="form-control"  value="<?php echo $query->mobile; ?>" >
                                <span style="color: red;"><?= form_error('mobile'); ?></span>
                            </div>

                            <div class="form-group">
                                <label for="exampleInputFile">Address</label>
                                <textarea name="address" class="form-control" rows=5><?php echo $query->address; ?></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <select class="multiselect-ui" name="branch[]" placeholder="Select Branch" multiple="">
                                    <?php foreach ($branch_list as $branch) { ?>
                                        <option value="<?php echo $branch->id; ?>" <?php if(in_array($branch->id,$branchs)) { echo "selected"; } ?>><?php echo $branch->branch_name; ?></option>
                                    <?php } ?>
                                </select>
