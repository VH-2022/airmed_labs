<section class="content-header">
    ...
    <section class="content">
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-sm-2">
                            <label>From Date</label>    <input type="text" name="start_date" placeholder="Select date" class="form-control datepicker-input" id="date"  value="<?= $start_date ?>" style="width:190px;" />
                            </div>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-yellow">
                    ...
                    <div class="info-box-content">
                        ...
                        <a href="<?php echo base_url();?>b2b/report/payment_report" style="color:white;"><span class="progress-description">
                                View More
                            </span></a>
