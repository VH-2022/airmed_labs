                                            ...
                                            <tbody id="t_body">
                                                ...
                                                foreach ($job_details[0]["test_list"] as $ts1) {
                                                    ...
                                                    <tr id="tr_<?= $cnt ?>">
                                                        ...
                                                        <td>Rs.<?= /* $ts1["info"][0]["price"]; */ $ts1['price']; ?></td>
                                                        <?php } ?>
												...
												<tr>
													...
													<th>Rs.<?= round($job_details[0]["collection_charge"]); ?></th>
...
<!--                                            <input type="file" id="common_report" name="common_report" required="">
											...
											<?php foreach($jobspdf as $pdf) { ?>
												...
												<a href="<?php echo base_url(); ?>upload/B2breport/<?php echo $pdf['report']; ?>?<?=date();?>" target="_blank"> <?php echo $pdf['original']; ?> </a><br>
