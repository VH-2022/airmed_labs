            ...
            <section class="content">
                <div class="row">
                    <div class="row">
                        <div class="col-md-6">
                            <?php if (isset($lab_id)) { ?>
                                <?php echo form_open_multipart("b2b/Lab/sample_add", array("role" => "form", "method" => "POST", "id" => "user_form")); ?>
                                <?php
                            } else if ($login_data["type"] != 4) {


                                echo form_open_multipart("b2b/Logistic/sample_add", array("role" => "form", "method" => "POST", "id" => "user_form"));
                            }
                            ?>
                                ...
                                <div class="box-body">
                                    ...
                                    <?php if (!isset($lab_id)) { ?>
                                        <div class="form-group col-sm-12  pdng_0">
                                            ...
                                            <div class="col-sm-9 pdng_0">
                                                <select class="form-control" id="lab" name="lab_id" onchange="get_lab_test(this.value);">
                                    ...
                                    <?php if (!isset($lab_id)) { ?>
                                        <div class="form-group col-sm-12  pdng_0">
                                            <label for="exampleInputFile" class="col-sm-3 pdng_0">Send To :<span style="color:red">*</span></label>
                                            <div class="col-sm-9 pdng_0">
                                                <select class="form-control" name="send_to" id="send_to">
                                                    <option value="">Select Destination Lab</option>
                                                    <?php foreach ($desti_lab as $lab) { ?>
                                                        <option value="<?php echo $lab['id']; ?>"><?php echo ucwords($lab['name']); ?></option>
                                                    <?php } ?>
                                                </select>
                                                <span style="color:red;" id="send_to_error"></span>
                                            </div>
                                        </div> <?php } else {
                                                    ?>
                                    <?php }
                        ...
                        <div class="col-md-6">
                            <div class="box box-primary">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><div id="received_div"><input type="text" name="received" id="received_val" value="" class="form-control"/><span id="received_amount_error" style="color:red;"></span></div></td>
                                                        </tr>
                                                        <tr style="display:none;">
                                ...
                                <?php if ($login_data["type"] != 4 || (isset($lab_id))) { ?>
                                    ...
                                    <script>
                                        ...
                                        function submit_type1(val) {
                                            ...
                                            if ($("#send_to").val() == '') {
                                                cnt = cnt + 1;
                                                $("#send_to_error").html("Required.");
                                            }
                                            if ($("#lab").val() == '') {
                                                cnt = cnt + 1;
                                                $("#lab_error").html("Required.");
                                            }
                                            if (dob == '') {
                                                cnt = cnt + 1;
                                            ...
                                            if (parseInt($("#received_val").val()) > parseInt($("#total_id").val())) {
                                                cnt = cnt + 1;
...
if (isset($lab_id)) {
    ...
    echo "$('#loader_div').show(); setTimeout(function(){ get_lab_test(" . $lab_id . "); }, 3000);";
}
?>
