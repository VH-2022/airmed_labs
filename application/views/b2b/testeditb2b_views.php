                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="desc" class="form-control"><?php echo $query[0]["description"]; ?></textarea>
											...
											<div class="form-group">
                                <label for="exampleInputFile">Thyrocare B2B Code</label>
							...
							<div class="form-group">
                                <label for="exampleInputFile">Specimen Type (Sample Type)</label>

				<select name="sample" class="form-control">
				<option  <?php echo $query[0]["sample"]=="SERUM"?"selected":""; ?> >SERUM</option>
				<option <?php echo $query[0]["sample"]=="EDTA"?"selected":""; ?> >EDTA</option>
				<option <?php echo $query[0]["sample"]=="HEPARIN"?"selected":""; ?> >HEPARIN</option>
				<option <?php echo $query[0]["sample"]=="URINE"?"selected":""; ?> >URINE</option>
				<option <?php echo $query[0]["sample"]=="FLUORIDE"?"selected":""; ?> >FLUORIDE</option>
</select>
