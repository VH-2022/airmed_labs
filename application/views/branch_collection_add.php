        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="col-md-6">
                        <!-- form start -->
                        <form role="form" action="<?php echo base_url(); ?>Branch_collections/add" method="post" enctype="multipart/form-data" id="branch_form">

                            <div class="form-group">
                                <label for="name">Date Of Inception</label><span style="color:red">*</span>
                                <input type="text"  name="inceptiondate" class="form-control datepicker-input" id="inceptiondate" placeholder="Date Of Inception" value="<?php echo set_value('inceptiondate'); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text"  name="address" class="form-control" id="address" placeholder="Address" ><?php echo set_value('address'); ?></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text"  name="remark" class="form-control" id="remark" placeholder="Remark" ></textarea>
                            </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="name">Integration Fees (Rs.)</label><span style="color:red">*</span>
                            <input type="text" name="total" class="form-control" id="total" placeholder="Total" value="<?php echo set_value('total'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"  name="discount" class="form-control" id="discount" placeholder="Discount" value="<?php echo set_value('discount'); ?>"> 
                            <input type="radio" name="dis_type" value="percentage" checked>% 
                            <input type="radio" name="dis_type" value="flat"> Flat 
                            <span class="errorvalidation" id="error_discount" style="color:red"></span>
                        </div>

                        <div class="form-group">
                            <label for="name">Net Pay</label><span style="color:red">*</span>
                            <input type="text"  name="net_pay" class="form-control" id="net_pay" placeholder="Net Pay" value="<?php echo set_value('net_pay'); ?>">
