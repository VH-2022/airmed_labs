                ...
                <div class="box box-primary" style="min-height: 500px;">
                    ...
                    <div class="box-body">
                        ...
                        <div class="box-body" style="display: none;">
                            <div class="widget">
                                <?php echo form_open("job_master/hours_list_search?hours=$hours&status=$status&ws=$ws&branch=$branch", array("method" => "GET", "role" => "form", "id" => "job_search")); ?>
                                <!-- <div class="form-group">
                        ...
                        <div class="box-body" >
                            <a style="float:right;margin-left:3px" href='<?= base_url(); ?>job_master/hours_list_export?hours=<?=$hours?>&status=<?=$status?>&ws=<?=$ws?>&branch=<?=$branch?>' id="job_search_btn" class="btn btn-sm btn-primary" ><i class="fa fa-download" ></i><strong > Export To CSV</strong></a>
                        </div>
