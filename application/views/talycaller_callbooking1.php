                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <?php echo form_open_multipart("Admin/TelecallerCallBooking_old", array("role" => "form", "method" => "POST", "id" => "user_form")); ?>
                                        ...
                                        <div class="form-group col-sm-12  pdng_0">
                                            ...
                                            <div class="col-sm-9 pdng_0">
                                                <select name="test_city" id="test_city" onchange="get_test(this);
                                                        get_branch(this.value);" class="form-control">
                                                        <?php
...
//                                            $("#address").val('');
                                    ...
                                    function get_test(val) {
                                        ...
                                        if (val.value.trim()) {
                                            $.ajax({
                                                url: '<?php echo base_url(); ?>Admin/get_test_list/' + val.value,
                                                type: 'post',
                                                data: {val: val.value},
                                                success: function (data) {
                                                    var json_data = JSON.parse(data);
                        ...
                        <div class="col-sm-12">
                            <div class="col-sm-6"> 
                                <div class="box box-primary">
                                    <div class="box-header">
                                        <!-- form start -->
                                        <h3 class="box-title">Clinical History:<span style="color:red;">*</span> </h3>
                                    </div>
                                    <div class="box-body">
                                        <div class="col-sm-12">
