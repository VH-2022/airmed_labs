        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <a href="<?=base_url();?>report_master/branchcreditors_csv/<?= $bid."/".$cid."?start_date=".$start_date."&end_date=".$end_date; ?>" class="btn btn-primary btn-sm pull-right">Export CSV</a>
                        <div class="widget">
