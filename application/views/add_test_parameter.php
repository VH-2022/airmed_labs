                                    ...
                                    <table id="" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <tr>
												...
												<td>
                                                    <input type="text" name="par_testcode" id="par_testcode" class="form-control">
                                                </td>															 
                                                <td>
                                                    <input type="text" name="par_method" id="par_method" class="form-control">
                                                </td>
                                                <td>
