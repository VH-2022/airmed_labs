...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Qoutation List</li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="invoice">
        ...
        <div class="row">
            ...
            <div class="widget">
                <?php echo form_open("vendor/Intent_genrate/quotation_list", array("method" => "GET")); ?>
                        ...
                        <tbody>
                            ...
                            foreach ($query as $row) {
                                ...
                                <tr>
                                    ...
                                    <td><?php if ($row["vendor_approve"] == "1") { ?>
                                <center><span class="label label-success ">Approved<span></span></span></center>
                            <?php } else { ?>
                                <center><span class="label label-warning ">Not Approved<span></span></span></center>
                            <?php } ?>
                            <td>
                                <?php if ($row["vendor_approve"] == "0") { ?>
                                    <a href='javascript:void(0)' data-toggle="tooltip" data-original-title="View" onclick="send_quot('<?php echo $row['id'] ?>')"><i class="fa fa-eye"></i></a>
                                <?php } else { ?>
                                    <a href="<?php echo base_url() . 'vendor/Intent_genrate/view_qot_details?id=' . $row["id"] ?>" target="_blank" data-toggle="tooltip" data-original-title="View" ><i class="fa fa-eye"></i></a>
                                <?php } ?>
                ...
                $(document).on('keydown', '.calution', function (e) {
                    if ($.inArray(e.keyCode, [46, 8, 9, 27, 13, 110, 190]) !== -1 ||
                        ...
                        function send_quot(id) {
                            $('#purch_or_id1').val(id);
                            $.ajax({
                                url: '<?php echo base_url(); ?>vendor/Intent_genrate/view_qoutation_list/?id=' + id,
                                type: 'GET',
                        ...
                        function tablecal(tid) {
                            ...
                            var itemnos = parseFloat($("#itemnos_" + trid).val());
