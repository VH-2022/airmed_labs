    ...
    <nav class="navbar navbar-static-top">
        <div class="">
            <div class="navbar-header">
                <a href="<?php echo base_url(); ?>vendor/admin/dashboard" class="navbar-brand" style="
                   padding-top: 0px;
                   padding-bottom: 0px;
            ...
            <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                <ul class="nav navbar-nav">
                    <li><a href="<?php echo base_url(); ?>vendor/admin/dashboard">Dashboard</a></li>
                    <li><a href="<?php echo base_url(); ?>vendor/Intent_genrate/index"> PO Generated List </a></li>
                    <li><a href="<?php echo base_url(); ?>vendor/Intent_genrate/quotation_list"> Quotation List </a></li>
                    <li><a href="<?php echo base_url(); ?>vendor/login/logout">Sign out</a></li>
            </div><!-- /.navbar-collapse -->
            <!-- Navbar Right Menu -->
