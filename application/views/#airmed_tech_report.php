<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url(); ?>bill_master/bill_list/"><i class="fa fa-users"></i>Airmed Tech Report</a></li>
    ...
    <section class="content">
        ...
        <!--                                    <a style="float:right;" href='<?php echo base_url(); ?>Airmed_tech_report/export_csv?bid=<?= $bid ?>' class="btn btn-primary pull-left" ><i class="fa fa-download" ></i><strong > Export To Data</strong></a>-->                                
                                    <a style="float:right;" href='<?php echo base_url(); ?>Airmed_tech_report/export_csv?bid=<?= $bid ?>&month=<?= $month ?>' class="btn btn-primary pull-left" ><i class="fa fa-download" ></i><strong > Export To Data</strong></a>
                                <?php //} ?>
