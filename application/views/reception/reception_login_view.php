    ...
    <body class="bg">
        <div class="login-box">
            ...
            <div class="login-box-body">
                ...
                <center><h3>Reception Login</h3></center>
                ...
                <form action="<?php echo base_url()."reception"; ?>" method="post">
                    <div id="login_div">
...
//end new counter
                                ...
                                function check_admin_login() {
                                    ...
                                    $.ajax({
                                        url: "<?php echo base_url(); ?>reception/login/verify_login",
                                        data: {
                                            email: email
                                        },
                                        type: "POST",
                                ...
                                function check_otp() {
                                    ...
                                    if (otp.trim() != '') {
                                        $.ajax({
                                            url: '<?= base_url(); ?>reception/login/check_otp',
                                            type: 'post',
                                            data: {otp: otp},
                                            success: function (data) {
                                                ...
                                                if (jsondata.status == 1) {
                                                    ...
                                                    setTimeout(function () {
                                                        window.location = '<?= base_url()."reception/appointment" ?>';
                                                    }, 1000);
                                                }
                                            },
