...
<section class="content-header">
    <h1>
        Add Test For <?= ucfirst($test_info[0]["name"]); ?>
        <small></small>
    </h1>
    <ol class="breadcrumb">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php foreach ($sub_test as $key) { ?>
                                        <tr>
                                            <td><?= ucfirst($key["city"]); ?></td>
                                            <td><?= ucfirst($key["test_name"]); ?></td>
                                            <td><?= ucfirst($key["price"]); ?></td>
                                            <td><a href="<?= base_url(); ?>test_panel/panel_test_delete/<?= $key["id"] ?>" onclick="return confirm('Are you sure?');" class="btn btn-danger">Delete</a></td>
                                        </tr> 
                                    <?php } ?>
