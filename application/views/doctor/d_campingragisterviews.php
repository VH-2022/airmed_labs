            ...
            <div class="col-xs-12">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
			         ...
			         <?php  echo form_open("doctor/camping/register/".$campdatils->id,array("method" => "POST", "role" => "form","class"=>'form-horizontal',"id"=>'reportform' )); ?>
...
<?php } ?>
 ...
 <?php echo form_close();  ?>
				...
				<?php  if($query != null){ ?>
						<a style="float:right;margin-right:5px;" href="<?= base_url()."doctor/camping/campragister_csv?cid=".$campdatils->id; ?>" class="btn btn-primary btn-sm"><strong> Export CSV</strong></a>
						<?php }  ?>
                                ...
                                <tbody>
                                    ...
                                    foreach ($query as $row) {
										...
										<?php if($camptype==2){ ?>	<td><?= $row['test']; ?></td> <?php } ?>
                                            ...
                                            <td>  
                                               <a  href='<?php echo base_url(); ?>doctor/camping/campregisterdelete/<?php echo $row['camp_fk']."/".$row['id']; ?>' data-toggle="tooltip" data-original-title="Remove" onclick="return confirm('Are you sure you want to remove this data?');"><i style="margin-left:10px; " class="fa fa-trash-o"></i></a>  
