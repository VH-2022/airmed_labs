        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="widget">
                           <?php echo form_open("doctor/report?from=$from&to=$to&regid=$regid&pname=$pname",array("method" => "GET", "role" => "form")); ?>
                        <div class="row">
                            <div class="col-sm-3">
                                <input type="text" name="regid" placeholder="Registration ID" class="form-control" id="regid"  value="<?=  $regid ?>" />
                            </div>
                            <div class="col-sm-3">
                                <input type="text" name="pname" placeholder="Patient Name" class="form-control" id="pname"  value="<?=  $pname ?>" />
                            </div>
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-2">
								...
								<a class="btn btn-primary" href="<?php echo base_url()."doctor/report?from=".date("d-m-Y")."&to=".date("d-m-Y")."&regid=&pname="; ?>">Reset</a>
                            </div>
                        </div>
                        <br>
                        <?php echo form_close();  ?>
