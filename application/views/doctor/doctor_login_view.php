    ...
    <body class="bg">
        <div class="login-box">
            ...
            <div class="login-box-body">
                ...
                <h1>
                    <!-- <img src="<?php echo base_url(); ?>user_assets/images/logo.png" alt="" style=" margin-left: 57px;" width="200px"> --></h1>
                ...
                <form action="<?php echo base_url()."doctor"; ?>" method="post">
                    <div id="login_div">
                        <div class="form-group has-feedback">
                            <input type="email" class="form-control" placeholder="Mobile no" id="email" name="email" value="<?php echo set_value('email'); ?>"/>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            <button type="button" onclick="check_admin_login();" id="send_btn" class="btn btn-primary btn-block btn-flat">Log In</button>
...
//end new counter
                                ...
                                function check_admin_login() {
                                    ...
                                    var email = $("#email").val();
                                    if (email == "") {
                                        $("#error_email").html("The mobile no field required");
                                        ecnt = 1;
                                    } else {
                                        if (!(checkemail(email))) {
                                            $("#error_email").html("Please Enter Valid Mobile no");
                                            ecnt = 1;
                                        }
                                    }
                                    /* if (password == "") {
                                    ...
                                    $.ajax({
                                        url: "<?php echo base_url(); ?>doctor/login/verify_login",
                                        data: {
                                            email: email
                                        },
                                        type: "POST",
                                ...
                                function check_otp() {
                                    ...
                                    if (otp.trim() != '') {
                                        $.ajax({
                                            url: '<?= base_url(); ?>doctor/login/check_otp',
                                            type: 'post',
                                            data: {otp: otp},
                                            success: function (data) {
                                                ...
                                                if (jsondata.status == 1) {
                                                    ...
                                                    setTimeout(function () {
                                                        window.location = '<?= base_url()."doctor/dashboard" ?>?id=<?php echo time(); ?>';
                                                    }, 1000);
                                                }
                                            },
