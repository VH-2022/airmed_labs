...
<html>
    ...
    <form action="<?php echo $action; ?>" method="post" name="payuForm" id='payuf' class="form-horizontal" style="display:none;">
        ...
        <input type="hidden" name="surl" value="<?php echo base_url() . 'user_test_master/success_payumoney/' . $testid . '/' . $payment_method . '/' . $test_city_session . '/' . $booking_info . "-" . $source_by; ?>/" size="64" /> 
        <td colspan="3"><input name="furl" type="hidden" value="<?php echo base_url() . 'add_wallet_master/fail_payumoney'; ?>" size="64" />
        <td colspan="3"><input name="service_provider" type="hidden" value="<?php echo base_url() . 'user_test_master/success_payumoney/' . $testid . '/' . $payment_method . '/' . $test_city_session . '/' . $booking_info . "-" . $source_by; ?>/" size="64" />
