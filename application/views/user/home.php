        ...
        <div class="container">                    
            <div class="section-content book_test">
                <div class="row multi-row-clearfix">
                    ...
                    <div class="col-md-12 col-sm-12">
                        <br />
                        **NABL Accredited tests<br />
                        ALBUMIN, BUN(BLOOD UREA NITROGEN), ALKALINE PHOSPHATASE, BILIRUBIN TOTAL, BILIRUBIN DIRECT-BC, CALCIUM, CRWATININE, CHOLESTEROL, GLUCOSE, HDL CHOLESTEROL, SGPT, SGOT, TOTAL PROTEIN, TRYGLYCERIDES, URIC ACID, UREA
                    </div>
                </div>
            </div>
