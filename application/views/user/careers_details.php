<style>
	.careet_dtls{margin-bottom:20px}
	.timeline-Widget--edge { overflow-y: scroll; height: 400px;}
	.careet_dtls .career_dtls_title h2{font-weight:normal;}
	.desc_p{border-bottom: 1px solid #ddd;
    padding-bottom: 10px;
    color: #000;
    font-size: 14px;
    float: left;
	...
	.uiScaledImageContainer._2zfr{min-width: 100% !important; width: 100% !important;}
</style>
<!-- Start main-content -->
<div class="main-content">
   <section id="about" class="package-div our_team" style="">
	...
	<div class="container">
		<div class="row">
			<div class="our_careers">
				<div class="col-md-4 col-sm-4">
					<iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fairmedpathlabs&tabs=timeline&width=340&height=500&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId=655569194623281" width="340" height="500" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
					<div class="twtr_blog" style="height:400px; overflow-y:scroll; margin-top:20px;">
						<a class="twitter-timeline" href="https://twitter.com/AirmedPathlabs?ref_src=twsrc%5Etfw">Tweets by AirmedPathlabs</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
					</div>
				</div>
				<div class="col-md-8 col-sm-8">
					<div class="col-md-12 col-sm-12 res_pdng_0">
						<div class="careet_dtls">
							...
							<div class="col-md-6 col-sm-6">
								...
								<p><strong>Location :</strong> Usmanpura</p>
							</div>
							<div class="col-md-6 col-sm-6">
								<p><strong>Qualification :</strong> MBBS</p>
								<p><strong>Experience :</strong> 5 to 10yrs</p>
							</div>
							</div>
						</div>
					</div>
					<div class="col-md-12 col-sm-12 res_pdng_0">
						<div class="careet_dtls">
							<div class="career_dtls_title">
								<h2>Why Airmed Pathology?</h2>
							</div>
							<div class="career_dtls_desc">
								<p>Department : Pathology</p>
								<p>Location : Usmanpura</p>
								<p>Qualification : MBBS</p>
								<p>Experience : 5 to 10yrs</p>
							</div>
						</div>
					</div>
				</div>
