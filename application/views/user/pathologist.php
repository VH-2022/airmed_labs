                ...
                <div class="row multi-row-clearfix">
                    ...
                    <div class="col-sm-12 col-md-12 mb-60 sm-text-center" style="background:#f1f2f3; box-shadow:1px 1px 10px #ccc; padding:10px 0; float:left;width:100%;">
                     ...
                     <div class="col-sm-12 col-md-12 mb-60 sm-text-center" style="background:#f1f2f3; box-shadow:1px 1px 10px #ccc; padding:10px 0; float:left;width:100%;">
                        <div class="col-sm-3">
                            <div class="my_team_lft_div">
                                <img src="http://www.airmedlabs.com/user_assets/images/my_team/6.jpg">
                            </div>
                        </div>
                        <div class="col-sm-9">
                            <div class="my_team_rgt_div">
                                <h1>Dr. Rachana Gohil</h1>
                                <h2>MD, Pathology</h2>

                                <div class="dcsrptn">
                                    <p>MBBS & MD from BJMC, Ahmedabad</p>
                    ...
                    <div class="col-sm-12 col-md-12 mb-60 sm-text-center" style="background:#f1f2f3; box-shadow:1px 1px 10px #ccc; padding:10px 0; float:left;width:100%;">
                        <div class="col-sm-3">
                            <div class="my_team_lft_div">
                                <img src="http://www.airmedlabs.com/user_assets/images/my_team/5.jpg">
                            </div>
                        </div>
                        <div class="col-sm-9">
                            <div class="my_team_rgt_div">
                                <h1>Dr. Nayan Patel</h1>
                                <h2>MBBS, DCP</h2>

                                <div class="dcsrptn">
                                   <p>MBBS & DCP from BJMC, Ahmedabad</p>
                                    <p>10 years of experience</p>
                                    <p>Area of interest </p>
