...
@media (max-width: 767px){
	.cntct_us_bg{background:none !important;}
}
</style>
<!-- Start main-content -->
                ...
                <div class="row">
                    <div class="col-md-offset-2 col-md-8 abt_addrs_pdng cntct_us_blog " style="margin-bottom: 5%;">
                        <div class="col-md-12 col-sm-12 res_pdng_0">
                            <h1 class="text-center txt_green_clr cntct_title">Feedback</h1>
                            <form id="feedback_form" name="contact_form" class=""  method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="message" class="form-control required" rows="5" placeholder="Enter Comment" id="cmessage" ></textarea>
  ...
  <!-- <section class="indx_mbl_ovrlay" style="margin-bottom:0; background:#d7d7d7; background-repeat:no-repeat; ">
    ...
    <script>
        ...
        function feedback() {
            ...
            var fields = $("#feedback_form").serializeArray();

            $.ajax({
                url: "<?php echo base_url(); ?>user_master/feedback_ins",
                data: fields,
                type: "POST",
                beforeSend: function () {
