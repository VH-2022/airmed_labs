...
<div class="main-content">
    ...
    <section id="about" class="package-div">
        ...
        <div class="gray-overlay" style="">
            <img src="<?php echo base_url(); ?>user_assets/images/new/inner-package.jpg">
        </div>
        <div class="container" style="padding:0">
            <div class="row">
                <div class="col-md-4">
                    <center>
                        <h1 class="font-62 font-w" style="color:#4d4d4f;line-height:30px">SWASTHYA </h1>
                        <p class="font-28">PROFILE- B <span class="font-20 clr-red">63 PARAMETERS</span></p>
                    </center>
                    <center>
                        <p><span class="back-red font-24 font-w pdng_10" style="margin:0 10px 0 0;color:#fff"><img src="<?php echo base_url(); ?>user_assets/images/new/rupee.png" style="width:12px"> 2999/- </span>
                            <span class="font-24" style="text-decoration: line-through;text-decoration-color:red;color:#4d4d4f;">6500/- </span></p>
                    </center>
                </div>
            ...
            <div class="section-content "> <!--col-md-10 col-md-offset-1-->
                <div class="row indx_round_div border-gray" style="">
                    <div class="col-md-8 col-xs-12">
                        <h1 class="font-32 font-w cust-mrg">SWASTHYA PROFILE B <span class="font-22 clr-red">63 PARAMETERS</span></h1>
                    </div>
                    <div class="col-md-4 col-xs-12 extra-div-right">
                        <a href="<?= base_url(); ?>User_master/all_package" class="btn-book mb-30 font-30 txt-transform-upp pull-xs-left">book test online</a><br/>
            ...
            <div class="section-content">
                <div class="container">
                    <div class="col-sm-12 pdng_0">
                            ...
                            <div class="col-md-4 pdng_0 ">
                                <a href="" class="hover-over">
                                    <div class="box-package ">
                                        <div class="red-label"><p>Rs.12,00</p></div>
                                        <div class="img-box">
                        ...
                        <center>
                            <a href="<?= base_url(); ?>User_master/all_package" class="btn btn-dark btn-theme-colored btn-flat mb-30 ">View More</a>
                        </center>
                    </div>
