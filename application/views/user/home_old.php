...
<style>
    ...
    @media only screen and (max-width: 767px) {
        ...
        .select2-container .select2-selection--single {border-radius: 20px !important; border: 1px solid #d01130 !important;}
        ul.token-input-list-facebook {background-color: #fff !important; border-radius: 20px !important; margin-top: 5px !important; border: 1px solid #d01130 !important;}
        ...
        <div class="modal-dialog home_mdl_dialog_cash">
            <div class="modal-content full_div text-center">
                <div class="modal-header full_div">
                    ...
                    <h4 class="modal-title home_mdl_title">Get 30% Cash Back On Online Booking</h4>
                </div>
        ...
        <div class="indx_big_img" style="background-image: url(<?php echo base_url(); ?>user_assets/images/banner1.jpg);">
            <div class="container">
                ...
                <div class="col-sm-12" style="margin-top: 1%;">
                    <div class="col-sm-12">
                        <div class="col-sm-3 col-sm-offset-5 set_sm_ofset_5" style="text-align:center;">
                ...
                <div class="full-width">
                    ...
                    <div class="col-md-2 col-sm-6 col-xs-6 res_for_bookng">
                        <div class="icon-box text-center">
                            <div class="col-md-12 col-sm-3 icon-content forbook res_indx_cl4_img">
                                <a href="javascript:" class="icon bg-theme-colored icon-circled icon-border-effect effect-circled icon-md hm_mdl_247_a four_img_hvr a_247_res_768media">
                                    <img class="" src="<?php echo base_url(); ?>user_assets/images/new/phone.png">
                                </a>
                            </div>
                            <div class="col-md-12 col-sm-9 icon-content forbook four_img_mrgntop_20px_768 pdng_0">
...
<script>
    ...
    function get_packages1(city_fk) {
        $.ajax({
            url: '<?= base_url(); ?>User_master/package_list1',
            type: 'post',
            tryCount: 0,
            retryLimit: 3,
            data: {city: city_fk},
...
<section class="pdng_all_container ">
    ...
    <?php echo $key['description']; ?> <!--<small><a href="#" class="bg-primary">More</a> </small>--></div>
                                                    <div class="col-sm-1"><img src="<?php echo base_url(); ?>user_assets/images/new/qoute-fisnish.png" class="pull-right" style="margin-top:60px;vertical-align:bottom"></div>
                                                </h3>
