  ...
  <div class="main-content">
    ...
    <section>
		<div class="container pdng_top_20px pdng_btm_30px">
			<div class="col-md-12 col-sm-12 res_pdng_lft_rgt_0">
			<h1 class="txt_green_clr">Health Feed</h1>
			</div>
		<div class="col-md-12 col-sm-12">
			<div class="row">
				<div class="col-md-9 col-sm-7 res_pdng_lft_rgt_0">
					...
					<div class="col-md-12 col-sm-12 helth_feed">
						<div class="main_helth_feed helth_feed_content">
							<div class="col-md-12 col-sm-12 pdng_0">
								<h3 class="mrgn_top_0 hlth_feed_title"><?php echo ucfirst($key['title']); ?></h3>
							</div>
...
?>
								<p class="pull-right hlth_fd_full_p">Posted on <?php echo $key['date'];?>..</p>
								<h3><?php echo substr($key['desc'],0,200); ?></h3>
								<a href="<?php echo base_url(); ?>user_master/health_feed_details/<?php echo $key['id']; ?>" class="btn start_quiz">Read More</a>
							</div>
						</div>
					</div>
					<?php } ?>
				</div>
				<div class="col-md-3 col-sm-5 res_pdng_lft_rgt_0">
								...
								<div class="thumb">
									...
									<div class="info p-15 pb-10 text-center">
										...
										<h5 class="occupation font-weight-400 letter-space-1 mt-0 six_part_price">
											<span class="no_price">Rs.<?php echo $key['a_price']; ?>/-</span>
											<span>Rs.<?php echo $key['d_price']; ?>/-</span>
										</h5>
									</div>
								</div>
							</a>
