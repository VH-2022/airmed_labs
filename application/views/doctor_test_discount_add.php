...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url(); ?>doctor_test_discount/doctor_test_discount_list"><i class="fa fa-users"></i>Doctor List</a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" action="<?php echo base_url(); ?>doctor_test_discount/doctor_test_discount_add" method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control chosen-select" name="lab_fk" onchange="state_list(this.value, '')">
                                    ...
                                    <?php foreach ($branch_list as $branch) { ?>
                                        <option value="<?php echo $branch['id']; ?>" <?php echo set_select('lab_fk', $branch['id']); ?>><?php echo $branch['branch_name'] ?></option>
                                    <?php } ?>
                                </select>
                            ...
                            <!--    <div class="form-group">
                                    ...
                                    <select class="form-control chosen-select"  name="doc_fk" onchange="state_list(this.value)">
                                        <option value="">--Select--</option>
                                        /*<?php //foreach ($doctor_list as $doctor) {    ?>
                                            <option value="<?php //echo $doctor['id'];    ?>"<?php //echo set_select('doc_fk',$doctor['id']);   ?>><?php //echo $doctor['full_name']    ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control chosen-select" name="test_fk" >
                                    ...
                                    <?php foreach ($test_list as $test) { ?>
                                        <option value="<?php echo $test['id']; ?>"<?php echo set_select('test_fk', $test['id']); ?>  ><?php echo $test['test_name'] ?></option>
                                    <?php } ?>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  name="price" class="form-control" min="1" max="100000"  value="<?php echo set_value('price'); ?>" >
    ...
    jQuery(".chosen-select").chosen({
        search_contains: true
            ...
            <script  type="text/javascript">
                ...
                function state_list(cid, selected) {
                    if (selected == '') {
                        selected = 0;
                    }
                    $.ajax({
                        url: '<?php echo base_url(); ?>doctor_test_discount/city_state_list',
                        type: 'post',
                        dataType:'html',
...
<?php if (!empty(set_value('lab_fk'))) { ?>
                    state_list('<?php echo set_value('lab_fk'); ?>', '<?= set_value('doc_fk'); ?>');
<?php } ?>
            </script>
        </div>
    </div>
