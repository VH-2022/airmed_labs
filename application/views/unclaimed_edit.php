<section class="content-header">
    <h1>Edit Unclaimed-Unpaid Amount</h1>
</section>
    ...
    <div class="box box-primary">
        ...
        <form method="post" enctype="multipart/form-data">
                ...
                <table class="table table-bordered">
                    ...
                    foreach ($files as $f) { ?>
                        <tr>
                            ...
                            <td>
                                <a target="_blank"
                                    href="<?= base_url('upload/unclaimed/' . $f['pdf_path']); ?>">
                                    View PDF
                                </a>
                            </td>
                        </tr>
            ...
            <div class="box-footer">
                ...
                <a href="<?php echo base_url(); ?>Investor_master/unclaimed_list" class="btn btn-default" style="float:right; margin-right:10px;" > Cancel </a>
            </div>
