...
<section class="content">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group col-sm-12  pdng_0">
                                            ...
                                            <div class="col-sm-9 pdng_0">
                                                <input type="text" id="name" name="name" value="<?= $job_details[0]["cusomer_details"][0]["full_name"]; ?>" class="form-control"/>
                                        ...
                                        <div class="form-group col-sm-12  pdng_0">
                                            ...
                                            <div class="col-sm-9 pdng_0">
                                                <input type="text" id="phone" name="phone" placeholder="Ex.9879879870" value="<?= $job_details[0]["cusomer_details"][0]["mobile"]; ?>" class="form-control"/>
                                        ...
                                        <div class="form-group col-sm-12  pdng_0">
                                            ...
                                            <div class="col-sm-9 pdng_0">
                                                ...
                                                <input type="text" id="email" class="form-control" name="email" value="<?= $job_details[0]["cusomer_details"][0]["email"]; ?>"/> 
                                        ...
                                        <div class="form-group col-sm-12  pdng_0">
                                            ...
                                            <div class="col-sm-9 pdng_0">
                                                <select name="gender" id="gender" class="form-control">
                                                    ...
                                                    if ($job_details[0]["cusomer_details"][0]["gender"] == "male") {
                                                        echo "selected";
                                                    }
                                                    ?>>Male</option>
                                                    <option value="female" <?php
                                                    if ($job_details[0]["cusomer_details"][0]["gender"] == "female") {
                                                        echo "selected";
                                                    }
                                                    ?>>Female</option>
                                                </select> 
                                        ...
                                        <div class="form-group col-sm-12  pdng_0">
                                            ...
                                            <div class="col-sm-9 pdng_0">
                                                <input type="text" id="dob" placeholder='Birth date' name="dob" class="datepicker form-control" value="<?= $job_details[0]["cusomer_details"][0]["dob"]; ?>" style="width:70%"/>OR<input type="text" class="form-control" style="width:20%" id="age_1" onkeyup="calculate_age(this.value);"/>
                                        ...
                                        <br>
                                        <div class="form-group col-sm-12  pdng_0">
                                            <label for="exampleInputFile" class="col-sm-3 pdng_0">Test city :</label> 
                                            <div class="col-sm-9 pdng_0">
                                                <select name="test_city" id="test_city" disabled="" onchange="get_test(this);" class="form-control">
                                                    <?php
                                        ...
                                        <div class="form-group col-sm-12  pdng_0">
                                            ...
                                            <div class="col-sm-9 pdng_0">
                                                <textarea id="address" name="address" class="form-control"><?= $job_details[0]["cusomer_details"][0]["address"]; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-12  pdng_0">
    ...
    <!--                                        <button class="btn btn-primary pull-right" id="show_test_btn" onclick="show_test_model1();" type="button" style="margin-right:20px"><i class="fa fa-plus-square" style="font-size:20px;"></i> Add Test/Package</button> 
                            ...
                            <div class="box box-primary">
                                ...
                                <form role="form" action="<?php echo base_url(); ?>Logistic/upload_report/<?= $id ?>" method="post" enctype="multipart/form-data" id="submit_report">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <input type="file" id="common_report" name="common_report" <?php if ($query[0]['status'] == "2") { ?> style="display:none;" <?php } ?> required=""
                                        ...
                                        <div class="form-group">
                                            <textarea class="form-control" name="desc_common_report"><?php echo $common_report[0]['description']; ?></textarea>
                                        </div>
                                        <div class="box-footer">
                        ...
                        <?php if ($login_data["type"] == 3) { ?>
                        <div class="col-md-6">
                            <a href="<?= base_url(); ?>upload/barcode/<?php echo $barcode_detail[0]["pic"]; ?>" target="_blank"><img src="<?= base_url(); ?>upload/barcode/<?php echo $barcode_detail[0]["pic"]; ?>" class="col-sm-12"/></a>
                        </div>
                        <?php } ?>
...
//        });
        ...
        var test_city = 4;
        $.ajax({
            url: "<?php echo base_url(); ?>logistic/get_city_test",
            type: 'post',
            data: {city: test_city},
            success: function (data) {
                //var json_data = JSON.parse(data);
