			...
			<div class="row">
				...
				<div class="col-sm-12">
					<div class="paid_due_chart_lwrsctn">
						<div class="col-sm-4">
							<label>Paid: <span>14,000</span></label>
						</div>
						<div class="col-sm-4">
							<label>Total: <span>30,000</span></label>
						</div>
						<div class="col-sm-4">
							...
							<!-- <a class="btn btn-block btn-primary btn-lg">Total Collection (PDF)</a> -->
						</div>
					</div>
				...
				<div class="col-sm-12">
					<div class="rfrl_btn">
						<ul class="inline-block">
							<li><a class="btn btn-block btn-default btn-lg" href="<?php echo base_url(); ?>logistic/finance_analytics">Referral Doctor Wise</a></li>
							<li><a class="btn btn-block btn-primary btn-lg" href="<?php echo base_url(); ?>logistic/rfrl_salesperson_wise">Referral SalesParson Wise</a></li>
