<div class="content-wrapper" id="extension-settings">
	...
	?>
        <h1>
         <?= $dockdetils->full_name." ".$pagename ?>
        </h1>
        <ol class="breadcrumb">
           <li><a href="<?php echo base_url()."dashboard"; ?>"><i class="fa fa-dashboard"></i>Home</a></li>
            <li><?= $dockdetils->full_name." ".$pagename ?></li>
        </ol>
    </section>
    <!-- Main content -->
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="widget">
						 ...
						 <?php if($camptype==1){ $cmapurl="camping/index/$dockid"; }else{ $cmapurl="camping/society/$dockid"; }						 
                                ...
                                <tbody>
                                    ...
                                    foreach ($query as $row) {
                                        ...
                                        <tr>
											...
											<td>  
                                                <a  href='<?php echo base_url()."camping/edit/".$row['id']; ?>' data-original-title="edit" data-toggle="tooltip" <i style="margin-left:3px; "class="fa fa-edit"> </i> </a>  
                                                
												
												<a  href='<?php echo base_url(); ?>camping/delete/<?php echo $row['id']; ?>' data-toggle="tooltip" data-original-title="Remove" onclick="return confirm('Are you sure you want to remove this data?');"><i style="margin-left:10px; " class="fa fa-trash-o"></i></a>  
												&nbsp
												<a  href='<?php echo base_url()."camping/register/".$row['id']; ?>' data-original-title="edit" data-toggle="tooltip" /> Registration</a>  
