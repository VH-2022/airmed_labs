...
<html>
    ...
    <form action="<?php echo $action; ?>" method="post" name="payuForm" id='payuf' class="form-horizontal" style="display:none;">
        ...
        <input type="hidden" name="surl" value="<?php echo base_url() . 'u/success_payumoney/' . $jid . '/' . $payamount.'/'.$test_city_session.'/'.$booking_info; ?>" size="64" /> 
        <td colspan="3"><input name="furl" type="hidden" value="<?php echo base_url() . 'u/fail_payumoney'; ?>" size="64" />
        <td colspan="3"><input name="service_provider" type="hidden" value="<?php echo base_url() . 'u/success_payumoney/' . $jid . '/' . $payamount.'/'.$test_city_session.'/'.$booking_info; ?>" size="64" /><input type="hidden" name="service_provider" value="payu_paisa" size="64" />
