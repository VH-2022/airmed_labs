    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" action="<?php echo base_url(); ?>press_release/index" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="exampleInputFile">News Logo</label>
                                <input type="file" id="exampleInputFile" name="news">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputFile">Pic</label>
