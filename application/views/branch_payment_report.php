            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <!-- Search start-->
                        <?php echo form_open("job_report/branchpayment", array("method" => "GET", "role" => "form")); ?>
                        <div class="row">
                            <div class="col-sm-3">
                                <input type="text" name="start_date" placeholder="Select date" class="form-control datepicker-input" id="date"  value="<?= $start_date ?>" />
                            </div>
                        ...
                        <div class="tableclass">
                            ...
                            <?php if (trim($start_date) != '' || trim($end_date) != '') { ?>
                                <a href="<?php echo base_url(); ?>job_report/daily_export?start_date=<?php echo $start_date; ?>&city=<?php echo $city; ?>&branch=<?php echo $branch; ?>" class="btn-sm btn-primary">Export</a><?php } ?>
                                ...
                                <table id="example4" class="table table-bordered table-striped">
                                    ...
                                    foreach ($collecting_amount_branch as $am_br) { //if($am_br['bid'] == $branch['id']) {  
                                        ...
                                        if (!in_array($am_br['bid'], $temparray)) {
                                            ...
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th><h4>Net Balance</h4></th>
                                                </tr>
                                            </thead>

                                        <?php } ?>
                                        <?php
                                        $gross += round($am_br['price']);
                                        $dis += round($am_br["discount"]);
                                        $neta += round($am_br['price']) - round($am_br["discount"]);
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php if ($am_br['phlebo_id'] == '') { ?><a href="<?= base_url(); ?>job_report/branchpayment_details?start_date=<?php echo $start_date; ?>&user=<?= $am_br["aid"] ?>&branch=<?= $am_br["bid"] ?>" target="_blank"><b><?php echo $am_br['name']; ?></b></a><?php } else { ?><a href="<?= base_url(); ?>job_report/branchpayment_details?start_date=<?php echo $start_date; ?>&phlebo=<?= $am_br["phlebo_id"] ?>&branch=<?= $am_br["bid"] ?>" target="_blank"><b><?php echo $am_br['name']; ?></a></b><?php } ?></td>
                                                <td><?php
                                                    if ($am_br['price'] != '') {
                                                        echo "Rs. " . round($am_br['price']);
                                                    } else {
                                                        echo "Rs. 0";
                                                    }
                                                    ?></td>
                                                ...
                                                $netbelance = round($net) - round($same);
                                                if ($netbelance < 0) {
                                                    $netbelance = 0.0;
                                                }
                                                $netb += $netbelance;
                                                ?>
                                                <td><?php echo "Rs." . $netbelance; ?></td>
                                            </tr>
