...
class Timeslot_master extends CI_Controller {
    ...
    function timeslot_add() {
        ...
        if ($this->form_validation->run() != FALSE) {
            ...
            $this->session->set_flashdata("success", 'Time Successfull Added.');
    ...
    function timeslot_delete() {
        ...
        $this->session->set_flashdata("success", 'Time Successfull Deleted.');
        redirect("Timeslot_master", "refresh");
    }
    function timeslot_edit() {
        ...
        if ($this->form_validation->run() != FALSE) {
            ...
            $cnt = 0;
            $this->session->set_flashdata("success", 'Time Successfull Updated');
            redirect("Timeslot_master", "refresh");
        } else {
