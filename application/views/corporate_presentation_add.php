...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url(); ?>Investor_master/corporate_presentation_list">Corporate Presentation List</a></li>
        <li class="active">Add Corporate Presentation</li>
    </ol>
</section>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <form role="form"
                      action="<?php echo base_url(); ?>Investor_master/corporate_presentation_add"
                      method="post"
