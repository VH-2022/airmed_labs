...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url()."paymentdue_registerreport/report"; ?>"><i class="fa fa-users"></i>Payment Due Register</a></li>
...
$credtejobuser=$this->input->get('credtejobuser');
 ...
 ?>
   ...
   <?php  echo form_open("paymentdue_registerreport/report", array("method" => "GET", "role" => "form","class"=>'form-horizontal',"id"=>'reportform' )); ?>
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        <input type="submit" name="search" class="btn btn-success" value="Search" />
		 <a href="<?= base_url()."paymentdue_registerreport/report"; ?>" class="btn btn-primary">Reset</a>
      </div>
        ...
        .on('changeDate', function (selected) {
            ...
            $('#startdate').datepicker('setEndDate', minDate);
														 ...
														 $("#reportcsv").click(function(){
															 location.href = '<?= base_url()."paymentdue_registerreport/report_exportcsv?" ?>'+$("#reportform").serialize();
