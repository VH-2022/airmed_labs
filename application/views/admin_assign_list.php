...
<style>
    ...
    <section class="content-header">
        <h1>Admin Assign Branch For Mail<small></small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>Dashboard1"><i class="fa fa-dashboard"></i>Dashboard</a></li>

            <li><i class="fa fa-users"></i>Admin Assign Branch For Mail List</li>
        </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Admin Assign Branch For Mail List</h3>
                    ...
                    <div class="box-body">
                        ...
                        <?php echo form_open('Admin_assign_branch', $attributes); ?>
                        <div class="col-md-3">
                                        ...
                                        <tr> <td><?php echo $counts + $cnt; ?></td>
                                           ...
                                           <td> <?php $exp = explode(',',$row['email']);
                                            ...
                                            <td><a href='javascript:void(0)' data-toggle="tooltip" data-original-title="Edit" onclick="edit('<?php echo $row['id'];?>','<?php echo $row['branch_fk'];?>')"><i class="fa fa-edit"></i></a> 
                                                <a  href='<?php echo base_url(); ?>Admin_assign_branch/delete/<?php echo $row['id']; ?>' data-toggle="tooltip" data-original-title="Remove" onclick="return confirm('Are you sure you want to remove this data?');"><i class="fa fa-trash-o"></i></a>
                                            </td>
                                        </tr>
...
<div id="myModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <?php echo form_open("Admin_assign_branch/add", array("method" => "POST", "role" => "form", "id" => 'submit_id')); ?>
...
<div id="myModalEdit" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <?php echo form_open("Admin_assign_branch/update", array("method" => "POST", "role" => "form", "id" => 'edit_submit_id')); ?>
...
<script>
    ...
    function submitData(){
       ...
       $.ajax({
            ...
            success: function (data) {
                if(data =='1'){
                window.location.href='<?php echo base_url();?>Admin_assign_branch';
            }if(data == '0'){
    ...
    $(".branch_select").attr("disabled", "disabled");
        /*AJAX start*/
        $.ajax({
            url: '<?php echo base_url(); ?>Admin_assign_branch/edit/' + tid,
            type: 'GET',
            success: function (data) {
