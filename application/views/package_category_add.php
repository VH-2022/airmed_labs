...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url(); ?>package_category/package_category_list"><i class="fa fa-users"></i>Package Category List</a></li>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="col-md-6">
                        ...
                        <!-- form start -->
                        <?php
                        echo form_open_multipart('package_category/package_category_add', ['method' => 'post', 'class' => 'form-horizontal',
                            'id' => 'target', 'enctype' => 'multipart/form-data']);
                        ?>
                        <div class="form-group">
                            <label for="start_time">Package Category Name</label><span style="color:red">*</span>
                            <?php echo form_input(['name' => 'pcname', 'class' => 'form-control', 'placeholder' => 'Package Category Name', 'value' => set_value('pcname')]); ?>
