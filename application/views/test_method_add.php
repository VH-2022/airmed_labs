    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" action="<?php echo base_url(); ?>test_method/add" method="post" enctype="multipart/form-data" id="test_submit">
                    ...
                    <div class="box-body">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="test_method" class="form-control"  value="<?php echo set_value('test_method'); ?>" id="test_method">
