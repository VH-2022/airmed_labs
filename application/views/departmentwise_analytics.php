<link href="bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
 ...
 <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Departmentwise Finance - Graph View
          </h1>
          <ol class="breadcrumb">
				<div class="btn-group">
			...
			<div class="row">
				...
				<div class="col-sm-12">
					<div class="paid_due_chart_lwrsctn">
						...
						<div class="col-sm-4">
						<a class="btn btn-block btn-primary btn-lg pull-right" href="#"><i class="fa fa-fw fa-file-excel-o"></i>Export Excel</a>
					...
					<div class="box box-primary top_rfrl">
						<div class="rfrl_tbl">
								<div class="box-header tbl_head">
								  <h3 class="box-title">Top 5 Department :</h3>
								</div>
