                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if (!empty($common_report)) { ?>
                                        <?php
                                        if ($query[0]["is_print"] == 0 && $query[0]["panel_test_count"] == 0 && $query[0]["model_type"] == 1) {
                    ...
                    <?php if ($query[0]["model_type"] == 1) {
                        ...
                        <div class="col-md-6 res_pdng_0">
                            ...
                            <?php if ($login_data['type'] == '1') { ?>
                                <div class="form-group">
                                    <label for="exampleInputFile">Registration Date:</label> <?php echo $query[0]['date']; ?>  <a href="javascript:void(0)" onclick="$('#registration_model').modal('show');"> <i class="fa fa-edit"></i></a>
                                </div>
                            <?php } ?>
                            <div class="form-group">
