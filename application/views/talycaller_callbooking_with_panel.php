...
<section class="content">
                ...
                <div class="nav-tabs-custom" style="margin-top:10px;">
                    <ul class="nav md-pills nav-justified pills-secondary">
                        <li class="nav-item active">
                            <a class="nav-link" data-toggle="tab" href="javascript:void(0);" role="tab">Patient Booking</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?= base_url(); ?>Btob_job_master/sample_add" role="tab">Lab Booking</a>
                        </li>
                    </ul> 
                </div>
            <?php } ?>
    ...
    <!--                    <li><a href="javascript:void(0);" onclick="window.location = '<?= base_url(); ?>Admin/Telecaller'" data-toggle="tab">All Jobs(Tests) <span id="pending_count_1" class="label label-danger">0</span> </a></li>
                        ...
                        <li class=""><a href="javascript:void(0);" ><input type='checkbox' id='exotelIVR' value='1'> Disable Exotel IVR</a></li>
                        ...
                        <div class="col-md-6">
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    <input type="hidden" id="debug" name="debug" value="<?php echo $_GET['debug']; ?>"> 
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group col-sm-12  pdng_0">
                                            ...
                                            <div class="col-sm-9 pdng_0">
                                                <input type="text" id="phone" name="phone" placeholder="Ex.9879879870" onkeyup="DelayedCallMe(200, this.value);" value="<?php echo ucwords($user_info[0]['mobile']); ?>" class="form-control"/>
                                        ...
                                        <script>
                                                    ...
                                                    if (tid == "16") { testcity = 408; }
                                                    if (tid == "17") { testcity = 347; }
                                                    if (tid == "18") { testcity = 407; }
                                                    if (tid == "19") { testcity = 351; }
                                                    if (tid == "20") { testcity = 346; }
                                                    if (tid == "21") { testcity = 353; }
                                                    if (tid == "22") { testcity = 375; }
                                                    if (tid == "23") { testcity = 1525; }
                                                    var cnt = 0;
                                                            if (d_name.trim() == '') {
                                                    cnt = 1;
                                                    ...
                                                    foreach ($branch_list as $branch) {
                                                        if ($login_data['type'] == 5 || $login_data['type'] == 6 || $login_data['type'] == 7) {
                                                            if (in_array($branch['id'], $cntr_arry)) {
                                                                ?>
                                                                <option data-ipd="<?= $branch['ipd'] ?>" value="<?php echo $branch['id']; ?>" selected><?php echo ucwords($branch['branch_name']) . " - " . $branch['branch_code']; ?></option>
                                                                <?php
                                                            }
                                                        } else {
                                                            ?>
                                                            <option data-ipd="<?= $branch['ipd'] ?>" value="<?php echo $branch['id']; ?>"><?php echo ucwords($branch['branch_name']) . " - " . $branch['branch_code']; ?></option>
                                        ...
                                        <div class="form-group col-sm-12  pdng_0">
                                            <label for="exampleInputFile" class="col-sm-3 pdng_0">Referral By :<span style="color:red">*</span></label>
                                            <div class="col-sm-9 pdng_0">
                                        ...
                                        <div class="form-group col-sm-12  pdng_0">
                                            ...
                                            <div class="col-sm-9 pdng_0">
                                                <select  name="sample_from" onchange="check_home_collection(this);" id="sample_from" class="chosen">
                                                    <option camping="" value="">--Select--</option>
                                                    <?php
                                                    foreach ($sample_from as $s_key) {
                                                        echo '<option camping="' . $s_key['camping'] . '" value="' . $s_key['id'] . '"';
                                                        echo '>' . ucwords($s_key['name']) . '</option>';
                                                    }
                                                    ?>
                                                </select>
                                                <input type="text" name="pincode" placeholder="Pin Code" class="form-control" id="pin_code_home_cc" style="display:none;"/>
                                                <script>
                                                            function check_home_collection(tag) {
                                                            var option = $('option:selected', tag).attr('camping');
                                                                    $("#checkcanping").html("");
                                                                    if (option == 1) {
                                                            $("#checkcanping").html('<div class="col-sm-9 pdng_0" style="float:right;"><input id="camoldpatient" name="oldpatient" value="1" type="checkbox"> <label for="camoldpatient">Mark as old patient</label></div>');
                                                            }

                                                            if (tag.value == '7') {
                                                            $("#pin_code_home_cc").attr("style", "margin-top:5px;");
                                                            } else {
                                                            $("#pin_code_home_cc").attr("style", "display:none;");
                                                            }
                                                            }
                                                </script>
                                        ...
                                        <div id="checkcanping" class="form-group col-sm-12  pdng_0" ></div>
                                        ...
                                        <div class="form-group col-sm-12  pdng_0" style="display: none;" id="ipdform">
                                            <label for="exampleInputFile" class="col-sm-3 pdng_0">IPD :<span style="color:red;">*</span></label>
                                            <div class="col-sm-9 pdng_0">
                                                <input type="text" name="ipd" id="ipd" class="form-control"/>
                                                <span style="color:red" id="ipd_error"></span>
                                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-group col-sm-12  pdng_0">
                                                    <div class="col-sm-9 pdng_0" style="float:right;">
                                                        <input type="checkbox" id="emergency_req" name="emergency" value="1"> <label style="color:red;font-size: 20px;" for="emergency_req">Mark as Emergency</label>
                                                    </div>
                                                </div>
                                                <div class="form-group col-sm-12  pdng_0">
                        ...
                        <div class="col-md-6">
                            <div class="box box-primary">
                                <div class="box-header">
                                        ...
                                        <div class="col-md-12" id="all_packages">
                                            <div class="col-md-12">
                                                <div class="col-md-12">
                                                    ...
                                                    <span><small><b>Note:- </b>Please fill all the required fields for patient information then submit test.</small></span>
                                                ...
                                                <div class="col-md-12" style="padding:0">
                                                    ...
                                                    <div class="table-responsive" style="overflow:hidden">
                                                        ...
                                                        function ApplyCollectionCharge(val) {
                                                                ...
                                                                if (val.checked == true) {
                                                                        $("#collectioncharge").show();
                                                                        $("#collectioncharge_id").val(100);
                                                                        var collectioncharge = $("#collectioncharge_id").val();
                                                                        ttl_price = Number(ttl_price) + Number(collectioncharge);
                                                                        $("#total_id").val(ttl_price);
                                                                }
                                                                if (val.checked == false) {
                                                                        $("#collectioncharge").hide();
                                                        ...
                                                        function ReCalculateCollectioncharge(collectioncharge){
                                                                var testtotal = $("#testtotal_id").val();
                                                                ttl_price = Number(testtotal) + Number(collectioncharge);
                                                                $("#total_id").val(ttl_price);
                                                                var dscnt = $("#discount").val();
                                                                get_discount_price(dscnt, '3');
                                                        }
                                                        ...
                                                        <table class="table">
                                                            <tr id="collectioncharge">
                                                                <th>Collection Charge Amount: Rs. </th>
                                                                <td><div id="collectioncharge_id_div">
                                                             <input type="text" onkeypress="return isNumberKey(event)" onkeyup="ReCalculateCollectioncharge(this.value);" name="collectioncharge_amount" id="collectioncharge_id" value="0" class="form-control"/>
                                                             <input type="hidden" name="testtotal_amount" id="testtotal_id" value="0" class="form-control"/>
                                                             </div>
                                                             </td>
                                                             </tr>
                                                            <tr>
                                                    ...
                                                    <input type="text" class="form-control" name="coupon" id="coupon" value='<?php echo $query[0]['coupon']; ?>' onblur="coupon_blur()" maxlength="6">
                                    ...
                                    <script>
                                                ...
                                                /* 
                                                 exotelIVR is used do disable exotel mobile number 
                                                 if its ticked then system not autopopulate window
                                                 */
                                                setInterval(function () {
                                                if ($('#exotelIVR')) {
                                                if (!$('#exotelIVR').prop('checked')) {
                                                getActiveCall();
                                                }
                                                }
                                        ...
                                        $("#testdiscount").hide();
                                                function get_test(val) {
                                                    var ipd=  $("#branch").find(':selected').data('ipd');
                                                        if(ipd==1){
                                                                $('#ipdform').show();
                                                        }else{
                                                            $('#ipdform').hide();
                                                ...
                                                var val = $("#test_city").val();
                                                        ...
                                                        /* if (val) {
                                                         $("#loader_div").show();
                                                         $.ajax({
                                                         url: '<?php echo base_url(); ?>Admin/getbranch_test_list/' + val + "/" + branch_val,
                                                         type: 'post',
                                                         data: {val: val.value},
                                                         success: function (data) {
                                                         var json_data = JSON.parse(data);
                                        ...
                                        var val = $("#test_city").val();
                                                var branch_val = $("#branch").val();
                                                var phone = $("#phone").val();
                                                var test_for = $("#test_for").val();
                                                if (branch_val == '') {
                                        branch_val = 0;
                                        }
                                        if (val.trim() && doc != "" && phone != ""){
                                        $("#loader_div").show();
                                                $.ajax({
                                                url: '<?php echo base_url(); ?>Admin/branch_doctor_test_list/' + val + "/" + branch_val + "/" + doc,
                                                        type: 'GET',
                                                        data: {val: val.value, phone:phone, test_for:test_for},
                                                        success: function (data) {
                                                        if (data != 0) {
                                                        var json_data = JSON.parse(data);
                                                                if (json_data.discount == '0') {
                                        ...
                                        var reffered_by = $("#referral_by").val();
                                                if (reffered_by.trim() == '') {
                                        cnt = cnt + 1;
                                                $("#referral_by_error").html("<br>Required");
                                                $("#submit_book_button").attr("disabled", false);
                                        }
                                        if (source1 == '') {
                                        cnt = cnt + 1;
                            ...
                            <script  type="text/javascript">
                                                    ...
                                                    var skillsSelect = document.getElementById("test");
                                                            ...
                                                            var testmrp = $('#test option:selected').attr('testmrp');
                                                            var testdisc = $('#test option:selected').attr('testdis');
                                                            var testreporting = $('#test option:selected').attr('reporting');
                                                            var samtype = $('#test option:selected').attr('samtype');
                                                            var testsamapletype = "";
                                                            if (samtype != ""){ var testsamapletype = '<br>(<small>' + samtype + '</small>)'; }
                                                    ...
                                                    show_details(explode[1]);
                                                            var clic = "'" + explode[1] + "'";
                                                            $("#city_wiae_price").append('<tr id="tr_' + $city_cnt + '"><td><a href="#" data-toggle="modal" data-target="#myModal_view" onclick="show_details(' + clic + ');">' + prc[0] + '</a></td><td>' + testreporting + '</td><td>Rs.' + testmrp + '</td><td>' + testdisc + '%</td><td>Rs.' + prc1[0] + '</td><td><a href="javascript:void(0);" onclick="delete_city_price(\'' + $city_cnt + '\',\'' + prc1[0] + '\',\'' + prc[0] + '\',\'' + skillsSelect.value + '\',\'' + testmrp + '\',\'' + testdisc + '\',\'' + testreporting + '\')">Delete</a></td></tr>');
    
                                                    if ($admintype != 1){
                                                    $packagecounter++;
                                                            $("#discount").val(0);
                                                            $("#testdiscount").css("display", "none");
                                                    }
                                                    ...
                                                    if (is_sub_test != 1) {
                                                    $("#city_wiae_price").append('<tr id="tr_' + $city_cnt + '"><td>' + prc[0] + '' + testsamapletype + '</td><td>' + testreporting + '</td><td>Rs.' + testmrp + '</td><td>' + testdisc + '%</td><td>Rs.' + prc1[0] + '</td><td><a href="javascript:void(0);" onclick="delete_city_price(\'' + $city_cnt + '\',\'' + prc1[0] + '\',\'' + prc[0] + '\',\'' + skillsSelect.value + '\',\'' + testmrp + '\',\'' + testdisc + '\',\'' + testreporting + '\',\'' + samtype + '\')">Delete</a></td></tr>');
                                                    }
                                                    if (is_sub_test == 1) {
                                                    $("#city_wiae_price").append('<tr id="tr_' + $city_cnt + '"><td><a href="#" data-toggle="modal" onclick="$(\'#sub_test_modal\'\).modal(\'show\'\);">' + prc[0] + '' + testsamapletype + '</a></td><td>' + testreporting + '</td><td>Rs.' + testmrp + '</td><td>' + testdisc + '%</td><td>Rs.' + prc1[0] + '</td><td><a href="javascript:void(0);" onclick="delete_city_price(\'' + $city_cnt + '\',\'' + prc1[0] + '\',\'' + prc[0] + '\',\'' + skillsSelect.value + '\',\'' + testmrp + '\',\'' + testdisc + '\',\'' + testreporting + '\',\'' + samtype + '\')">Delete</a></td></tr>');
                                                    }
                                                    }
                                                    $("#test option[value='1']").remove();
                                                            ...
                                                            $("#total_id").val( + old_price + + prc1[0]);
                                                            $("#testtotal_id").val( + old_price + + prc1[0]);
                                                            var dscnt = $("#discount").val();
                                                            get_discount_price(dscnt, '4');
                                            ...
                                            $('#test_panel').append('<option value="' + value + '">' + name + ' (Rs.' + prc + ')</option>').trigger("chosen:updated");
                                                    ...
                                                    $("#testtotal_id").val(old_price - prc);
                                                    var dscnt = $("#discount").val();
                                                    get_discount_price(dscnt, '4');
                                                    /*Total price calculate end*/
                                                    $("#tr_" + id).remove();
                                            ...
                                            function delete_city_price(id, prc, name, value, mrp = null, mrpdis = null, reporting = null, samtype = null){

                                            var tst = confirm('Are you sure?');
                                                    if (tst == true) {
                                            /*Total price calculate start*/
                                            $('#test').append('<option samtype="' + samtype + '" reporting="' + reporting + '" testmrp="' + mrp + '" testdis="' + mrpdis + '" value="' + value + '">' + name + ' (Rs.' + prc + ')</option>').trigger("chosen:updated");
                                                    var old_price = $("#total_id").val();
                                                    $("#total_id").val(old_price - prc);
                                                    $("#testtotal_id").val(old_price - prc);
                                                    var dscnt = $("#discount").val();
                                                    ...
                                                    if($admintype!=1){
    var pkgval = value.split("-");
    if(pkgval[0]=="p"){
        $packagecounter--;
        if($packagecounter==0){
           $("#discount").val(0);
           $("#testdiscount").css("display", "table-row");
        }
    }
}
                                                    //get_test($("#test_city"));
...
//            format: 'yyyy-mm-dd'
                    ...
                    tst_details = '';
                            ...
                            url: '<?php echo base_url(); ?>Admin/get_refered_by',
                                    ...
                                    var branch_val = $("#branch").val();
                                    $.ajax({
                                    url: '<?php echo base_url(); ?>Admin/getbranch_test_list/' + tst_cty + "/" + branch_val,
                                            type: 'post',
                                            data: {val: tst_cty},
                                            success: function (data) {
                                            var json_data = JSON.parse(data);
                            ...
                            $.ajax({
                            url: '<?php echo base_url(); ?>job_master/telecaller_get_branch',
                                    type: 'post',
                                    data: {city: val},
                                    beforeSend: function () {
                                    $("#branch").html("");
		...
		var prev_coupon = '';
    var coupon_valid = true;
    function coupon_blur() {
        $('#couponerr').text("");

        var codeval = $('#coupon').val();
        if(codeval == '' && prev_coupon != '')
        {            
			$("#discount").val('');
			$("#discount").prop('readonly', false);
			$("#price_per_discount").prop('disabled', false);
			$("#flat_discount").prop('disabled', false);
			$("#price_per_discount").trigger("change");
            prev_coupon = codeval;
        }
        else
            prev_coupon = codeval;
        ...
        if(codeval != '')
        {
            ...
            if(customer_test.length == 0)
            {
                $('#coupon').val("");
                $('#couponerr').text("Please select test");
                return;
            }

            var apiurl = 'https://usmanpuraimaging.com/paramedics/service/discount_service_v1/is_code_valid_patho';
            //var apiurl = 'http://localhost:9999/paramedics/service/discount_service_v1/is_code_valid_patho';
            ...
            const fetchPromise = fetch(apiurl, req_body);
            ...
            .then( json => {            
                ...
                {
                    coupon_valid = false;
                    $('#couponerr').text("Please enter valid Discount Code");                    
					$("#discount").val('');
					$("#discount").prop('readonly', true);
					//$("#price_per_discount").prop('disabled', true);
					$("#price_per_discount").prop("checked", true);
					$("#flat_discount").prop('disabled', true);
					$("#price_per_discount").trigger("change");
                ...
                else
                {
                    coupon_valid = true;
                    $('#couponerr').text("");
                    //var tests = $("#hidden_test").html();
                    //console.log(tests);
                    
					var price = 15; //(customer_test_price[cn] * 15) / 100;
					$("#discount" ).val(price);
					$("#discount").prop('readonly', true);
					$("#price_per_discount").prop("checked", true);
					//$("#price_per_discount").prop('disabled', true);
