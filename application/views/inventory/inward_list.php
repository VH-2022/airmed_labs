...
<!--                        <th>Machine Name</th>-->
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td></td>
                                <td><select name="branch_fk" class="form-control chosen chosen-select" data-placeholder="choose a language...">
                                ...
                                <td>
                                    <select name="machine_fk" class="form-control chosen chosen-select" data-placeholder="choose a language...">
                                        <option value="">--Select--</option>
                                        <?php
                            ...
                            foreach ($final_array as $valTest) {
                                ...
                                <tr>
									...
									if($login_data["type"]==1 || $login_data["type"]==2){
									 ...
									 if($valTest['a_notity']==1){ echo '<span class="round round-sm blue"></span>'; } 
									 
										}else if($login_data["type"] ==8){
											if($valTest['i_notiy']==1){ echo '<span class="round round-sm blue"></span>'; }
										}else{
											if($valTest['b_notity']==1){ echo '<span class="round round-sm blue"></span>'; }
										} ?>
                                    </td>
                                    <td>
