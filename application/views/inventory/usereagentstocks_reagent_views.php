...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?= base_url() . "inventory/indent_usereagent"; ?>"><i class="fa fa-dashboard"></i> Use Reagent List</a></li>
            <li class="active">Use Reagent stocks</li>
        </ol>
    </section>
    <!-- Main content -->
                    ...
                    <table class="table-striped">
                        ...
                        <tbody>
                            ...
                            foreach ($query as $row) {
                                $i++;
                                $timeperfomace = ($row["timeperfomace"]>0)?$row["timeperfomace"]:1;
                                ?>
                                <tr>
                                    <td><?= $i; ?></td>
                                    <td><?= $row["order_id"]; ?></td>
                                    ...
                                    <td><?= $timeperfomace; ?></td>
                                    <td><?= $row["useditem"]; ?></td>
                                    <td><?= ($row["useditem"] * $timeperfomace); ?></td>
                                    <?php /* <td><?= date("d-m-Y", strtotime($row["creteddate"])); ?></td> */ ?>
   
                                </tr>
                                <?php
                                $totaluse += $row["useditem"];
                                $pertotaluse += $timeperfomace;
                                $totalqty += ($row["useditem"] * $timeperfomace);
                            }if (empty($query)) {
                                ?>
                                <tr>
