            ...
            <div class="box box-primary">
             ...
             <!--    <p class="help-block" style="color:red;"><?php
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-6">
                        <!-- form start -->
                        <form role="form" id="handover_form" action="<?php echo base_url(); ?>inventory/Handover_item/add" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="handover_branch" class="chosen chosen-select" data-placeholder="choose a language..." id="handover_branch">
                                    <option value="">--Select--</option>
                                    <?php foreach ($branch_list_1 as $key => $val) { ?>
                                        <option value="<?php echo $val['id']; ?>"><?php echo $val['branch_name']; ?></option>
                                    <?php } ?>
                                </select>
                                <span style="color:red"></span>
...
$("#handover_form").submit(function (e) {
        
        var error = 1;
        var from_branch = $("#branch_id").val();
        var to_branch = $("#handover_branch").val();

        if (from_branch != "" && to_branch != "") {
            if (from_branch == to_branch) {
                error = 0;
                alert('Handover to branch is same as Handover from please select another branch.')
            }
        }
