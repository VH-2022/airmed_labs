...
<style>
    ...
    @media (max-width: 980px) {
        ...
        .pending_job_list_tbl td:nth-of-type(3):before {content: "Reagent";}
        .pending_job_list_tbl td:nth-of-type(4):before {content: "Batch No.";}
        .pending_job_list_tbl td:nth-of-type(5):before {content: "Expire";}
        .pending_job_list_tbl td:nth-of-type(6):before {content: "Quantity";}
                            ...
                            <tbody>
                                ...
                                foreach ($query as $valTest) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            if ($valTest['expire_date'] != "0000-00-00" && $valTest['expire_date'] != "1970-01-01") {
                                        ...
                                        <td>
                                            <a href="<?php echo base_url(); ?>inventory/stock_master/edit_stock/<?php echo $valTest['inward_fk']; ?>"><i class="fa fa-edit" aria-hidden="true"></i></a>
