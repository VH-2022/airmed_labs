                    ...
                    <div class="col-md-6">
                        ...
                        <form role="form" action="<?php echo base_url(); ?>inventory/Vendor_master/add" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="<?= set_value("bank_name") ?>"  name="bank_name" class="form-control" value="<?php echo set_value("bank_name"); ?>">
                                <?php echo form_error('bank_name'); ?>
                            </div>
                            <div class="form-group">
                                <label for="name">Branch Name</label>
                                <input type="text" value="<?= set_value("branch_name") ?>" name="branch_name" class="form-control" value="<?php echo set_value("branch_name"); ?>">
                                <?php echo form_error('branch_name'); ?>
                            </div>
                            <div class="form-group">
                                <label for="name">Account No</label>
                                <input type="text" value="<?= set_value("account_no") ?>" name="account_no" class="form-control" value="<?php echo set_value("account_no"); ?>">
                                <?php echo form_error('account_no'); ?>
                            </div>
                            <div class="form-group">
                                <label for="name">IFSC Code</label>
                                <input type="text" value="<?= set_value("ifsc_code") ?>" name="ifsc_code" class="form-control" >
