...
<html>
    ...
    <table border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
        <tr>
            ...
            <td rowspan="3" style="width:20%"><img class="set_logo" src="logo.png" style="width:17%;height:auto;padding-left: 5px;"/></td>
        </tr>
        <tr>
...
<!--<pagebreak>-->
                                            <table border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                                                ...
                                                <thead>
                                                    ...
                                                    <tr>
                                                        <th colspan="2" style="width: 15%">Item Name:</th>
                                                        <th colspan="8" style="width: 65%"><?php
                                                            if ($query[0]['reagent_name'] != "") {
                                                                echo $query[0]['reagent_name'];
                                                            } else {
                                                                "-";
                                                            ...
                                                            ?></th>
                                                        <th colspan="2" style="width: 20%">Page No.</th>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    if ($start_date != "" && $end_date != "" && $branch != "" && $item != "") {
                                                        ...
                                                        foreach ($new_array as $row) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo $row['issue']."/".$row["wastage"]; ?></td>
