...
<div class="content-wrapper">
    ...
    <section class="invoice">
        ...
        <div class="row">
            <div class="col-md-12">
                <span style="float: right;"><a href="javascript:void(0);" onclick="$('#myModal').modal('show');" class="btn btn-primary btn-sm">Request Item</a></span>    
                <form role="form" action="<?php echo base_url(); ?>inventory/Intent_Request/sub_index" method="get" enctype="multipart/form-data">
                        ...
                        <tbody>
                            ...
                            foreach ($final_array as $valTest) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo "<br><small><b>#</b>" . $valTest['indent_fk'] . '<br><small><b>Added By-</b>' . $valTest["admin_name"] . '</small>'; ?>
                                    </td>
                                    <td><?php
                                    ...
                                    <td>
                                        <?php foreach ($valTest['details'] as $key => $new_array) {
                                            ...
                                            <?php foreach ($new_array['reagent'] as $key => $all_merge) { ?>
                                                ...
                                                <?php
                                                if ($all_merge['unit_fk'] != '') {
                                                    $unit_sub = explode(",", $all_merge['Unit_name']);
                                                }
                                                ...
                                                foreach ($old_new as $d1) {
                                                    $new_unt = (!empty($unit_sub[$crq])) ? $unit_sub[$crq] : "";
                                                    ?>

                                                    <?php echo "<small>-".$old[$crq]; ?> &nbsp;( <?php echo $d1 . ' '.$new_unt.')</small><br>'; ?>
                                    ...
                                    <td>
                                        ...
                                        if ($valTest['iiSTATUS'] == 1) {
                                            ...
                                            if ($valTest['po_details'][0]['id'] != "") {

                                                echo "<a href='" . base_url("inventory/intent_genrate/poigeneratedetils/" . $valTest['po_details'][0]['id']) . "' class='label label-success '>PO Generated</a>";
                                            } else {
                                                echo "<span class='label label-warning '>Waiting for HO Approval</span>";
                                            }
                                        }
                                        ?>
                                    ...
                                    <td> 
                                        <?php if ($login_data['type'] == 5) { ?>
                                            <?php if ($valTest['iiSTATUS'] == 1) { ?>
                                                <a href='<?php echo base_url(); ?>inventory/Intent_Request/get_print_form/<?php echo $valTest['intent_id']; ?>/<?php echo $valTest['iiSTATUS']; ?>' data-toggle="tooltip" data-original-title="Print Report"><span class=""><i class="fa fa-print"></i></span></a>  
                                            <?php } else { ?>

                                                <a href="<?php echo base_url(); ?>inventory/Intent_Request/get_proved/<?php echo $valTest['intent_id']; ?>" data-toggle="tooltip" data-original-title="Approved"  onclick="return confirm('Are you sure?');"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i></a>
                                                <a href="javascript:void(0);" onclick="edit('<?php echo $valTest['intent_id']; ?>', '<?php echo $valTest['BranchId']; ?>')" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-edit"></i></a>
                                                <a href="<?php echo base_url(); ?>inventory/Intent_Request/delete/<?php echo $valTest['intent_id']; ?>" onclick="return confirm('Are you sure?');" data-toggle="tooltip" data-original-title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                <?php
                                            }
                                        }
                                        ?>
                                        <?php
                                        if (in_array($login_data['type'], array("1", "2", "8"))) {
                                            if ($valTest['iiSTATUS'] == 1) {
                                                ?>
                                                ...
                                                <a href="<?php echo base_url(); ?>inventory/Intent_Request/delete/<?php echo $valTest['intent_id']; ?>" onclick="return confirm('Are you sure?');" data-toggle="tooltip" data-original-title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                            <?php } else { ?>
                                                <a href="<?php echo base_url(); ?>inventory/Intent_Request/get_proved/<?php echo $valTest['intent_id']; ?>" data-toggle="tooltip" data-original-title="Approval" onclick="return confirm('Are you sure?');"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i></a>
                                        ...
                                        if ($valTest['iiSTATUS'] == 1 && $valTest['postatus'] == 2 && $login_data['type'] == '8') {
                                            ?>

                                            <a href="<?php echo base_url(); ?>inventory/Intent_Request/poigenerate/<?php echo $valTest['intent_id']; ?>" class='btn btn-sm btn-primary' data-toggle="tooltip" data-original-title="PO Request" >PO Request</a>
                ...
                <div style="display: none;" id="show_hide">
                    <div id="items_list">
                        ...
                        <div class="form-group">
                            ...
                            <select class="chosen chosen-select consume_update" name="category_fk" id="consumer_id" onchange="select_item('Consumables', this);">
                        ...
                        <div class="form-group">
                            ...
                            <select class="chosen chosen-select stationary_update" name="category_fk" id="yahoo_id" onchange="select_item('Stationary', this);">
                                <option value="">--Select--</option>
...
<script>
    ...
    function select_item(val, id) {
        ...
        $("#selected_items").append('<tr id="tr_' + $city_cnt + '"><td>' + prc + '<input type="hidden" name="item[]" value="' + pm + '"></td><td>' + val + '</td><td><input type="text" name="quantity[]" required="" class="form-control dummyTekst" value=""/><span class="quantity_error_id" style="color:red;"></span></td>  <td><input type="text" name="lot[]" class="form-control" value=""/><span class="lot_error_id" style="color:red;"></span></td> <td><select name="vendor[]" class="form-control">' + $vandor_list + '</select></td> <td><a href="javascript:void(0);" onclick="delete_city_price(\'' + $city_cnt + '\',\'' + prc + '\',\'' + pm + '\',\'' + val + '\')"><i class="fa fa-trash"></i></a></td></tr>');
    ...
    function edit(tid, cid) {
        ...
        /*AJAX start*/
        $.ajax({
            url: '<?php echo base_url(); ?>inventory/Intent_Request/edit/' + tid+'/'+cid,
            type: 'GET',
    ...
    function delete_city_price_edit(id, name, value, val) {
        ...
        if (tst == true) {
            ...
            if (val == "Consumables") {
                $('#consumables_id_edit').append('<option value="' + value + '">' + name + '</option>');
            }
            if (val == "Stationary") {
                $('#stationary_id_edit').append('<option value="' + value + '">' + name + '</option>');
            }
            $("#tr_edit_" + id).remove();
            $nc('.chosen').trigger("chosen:updated");
        }
    ...
    function getReagent() {
        ...
        if (id.trim() != '') {
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>inventory/Intent_Request/labconsume",
                type: "POST",
                data: {branch_fk: id},
                success: function (data) {
                    console.log(data);
                    $('.consume_update').html(data);
                    $nc('.chosen').trigger("chosen:updated");
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>inventory/Intent_Request/stationary",
                type: "POST",
                data: {branch_fk: id},
                success: function (data) {
                    console.log(data);
                    $('.stationary_update').html(data);
                    $nc('.chosen').trigger("chosen:updated");

                }
            });
            $.ajax({
                url: "<?php echo base_url(); ?>inventory/Intent_Request/vender_list",
                type: "POST",
                data: {branch_fk: id},
                success: function (data) {
                    if (data != '') {
                        ...
                        $vandor_list = "<option value=''>No Record</option>";
                    }
                }
            });
            $('#show_hide').show();
    ...
    function getReagent_test(val) {
        setTimeout(function () {
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>inventory/Intent_Request/getsub",
                type: "POST",
                data: {branch_fk: val,selected:$selected_item},
                success: function (data) {
