            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <!-- Search start-->
                        <?php echo form_open("inventory/Stock_issue_report/index", array("method" => "GET", "role" => "form")); ?>
                        <div class="row">
                            <div class="col-sm-2">
                            ...
                            <div class="col-sm-2">
                                <select class="form-control chosen" data-placeholder="Select Item" tabindex="-1" name="item" id="item">
                                    <option value="" >Select Item</option>
                                    <?php
                                    if ($branch != "") {
                                        foreach ($item_list as $item1) {
                                            ?>
                                            <option value = "<?php echo $item1['id']; ?>" <?php
                                            if ($item1['id'] == $item) {
                                                echo "selected";
                                            }
                                            ?>> <?php echo $item1['reagent_name'] ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
                            ...
                            <div class="col-sm-2">
                                ...
                                <a style="float:right;margin-right:5px;" href='<?php echo base_url(); ?>inventory/Stock_issue_report/get_pdf?start_date=<?php echo $start_date ?>&end_date=<?php echo $end_date ?>&branch=<?php echo $branch ?>&item=<?php echo $item ?>' class="btn btn-primary btn-sm" >Generate PDF</a>
                            </div>
                        </div>
                        <br>
                        <?php echo form_close(); ?>
                                ...
                                <table id="example4" class="table table-bordered table-striped">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th colspan="8"><center><?=$query[0]["location"]?></center></th>
                                    <th colspan="2"></th>
                                    </tr>
                                    <tr>
