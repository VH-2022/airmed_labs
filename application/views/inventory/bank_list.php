            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-2">
                            <input type="text" class="form-control" name="ifc_code" placeholder="Enter IFSC Code" value="<?php echo $ifc_code; ?>" tabindex='3'/>
                        </div>
                         <div class="col-md-2">
                            <input type="text" class="form-control" name="account_no" placeholder="Enter Account No" value="<?php echo $account; ?>" tabindex='4'/>
                        </div>
                         <div class="col-md-2">
                            <input type="text" class="form-control" name="city" placeholder="Enter City Name" value="<?php echo $city; ?>" tabindex='5'/>
                        </div>
