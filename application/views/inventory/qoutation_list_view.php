...
<div class="content-wrapper">
    ...
    <section class="invoice">
        ...
        <div class="row">
            ...
            <div class="widget">
                <?php echo form_open("inventory/Intent_genrate/vendor_qout_list", array("method" => "GET")); ?>
                        ...
                        <tbody>
                            ...
                            foreach ($query as $row) {
                                ...
                                <tr>
                                    ...
                                    <td><?php if($row["inventory_approve"] == '1'){?>
                                        <span class="label label-success">Approve</span>
                                    <?php }else{?>
                                        <span class="label label-warning">Not Approve</span>
                                    <?php } ?></td>
                                    <td>
                                    <a href="<?php echo base_url().'inventory/Intent_genrate/view_qot_details?id='.$row["id"]?>" target="_blank" data-toggle="tooltip" data-original-title="View" ><i class="fa fa-eye"></i></a>
                                    <?php //if($row["inventory_approve"] == '0'){ ?>
<!--                                    <a onclick="return confirm('Are you sure you want to Approve?');" href='<?php //echo base_url() . "inventory/intent_genrate/approve_qout_inventory?id=" . $row['id']; ?>' class="btn btn-primary btn-sm" style="margin-top:2px">Approve</a>-->
                                    <?php //} ?>
                                    </td>
                                </tr>
                                <?php
