...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Edit Lab Consumables</li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="col-md-6">
                        <!-- form start -->
                        <form role="form" action="<?php echo base_url(); ?>inventory/Consumes_master/consumes_edit/<?= $query[0]['id']; ?>" method="post" enctype="multipart/form-data">
                            <input type="hidden"  name="id" class="form-control" value="<?php echo $query[0]['id']; ?>" >
                            <div class="form-group">
                                <label for="name">Name</label><span style="color:red">*</span>
                                <input type="text"  name="name" value="<?php echo $query[0]['reagent_name']; ?>" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <select name="city_fk" class="form-control" onchange="getCity();" id="city_id">
                                    ...
                                    <?php foreach ($city_list as $val) { ?>
                                        <option value="<?php echo $val['id']; ?>" <?php if ($query[0]['city_fk'] == $val['id']) {
                            ...
                            <div class="form-group">
                                ...
                                <select name="branch_fk" class="form-control"  id="branch_id">
                                    ...
                                    <?php foreach ($branch_list as $branch) { ?>
                                        <option value="<?php echo $branch['id']; ?>" <?php if ($query[0]['branch_fk'] == $branch['id']) {
                                        echo "selected='selected'";
...
<?php } ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  name="quantity" value="<?php echo $query[0]['quantity']; ?>" class="form-control">
...
<?php echo form_error('quantity'); ?>
                            ...
                            <div class="form-group">
                                ...
                                <?php foreach ($unit_list as $key => $val) { ?>
                                        <option value="<?php echo $val['id']; ?>" <?php if ($query[0]['unit_fk'] == $val['id']) {
                                    echo "selected='selected'";
                                } ?>><?php echo $val['name']; ?></option>
...
<?php foreach ($brand_list as $key => $val) { ?>
                                        <option value="<?php echo $val['id']; ?>"<?php if ($query[0]['brand_fk'] == $val['id']) {
        echo "selected='selected'";
...
<?php echo form_error('brand_fk'); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  name="box_price" class="form-control" placeholder="Enter Box Price" value="<?php echo $query[0]['box_price']; ?>">
<?php echo form_error('box_price'); ?>
                            </div>
                            <div class="form-group">
                                <label for="name">HSN Code</label>
                                <input type="text"  name="hsn_code" class="form-control" placeholder="Enter HSN Code" value="<?php echo $query[0]['hsn_code']; ?>">
<?php echo form_error('hsn_code'); ?>
                            </div>
                            <div class="form-group">
                                <label for="name">Location</label>
                                <input type="text"  name="location" class="form-control" placeholder="Enter Location" value="<?php echo $query[0]['location']; ?>">
                            </div>
