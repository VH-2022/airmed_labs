            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Handover Item List</h3>
                             <a style="float:right;" href='<?php echo base_url(); ?>inventory/Handover_item/add' class="btn btn-primary btn-sm" ><i class="fa fa-plus-circle" ></i><strong >Add</strong></a>
                                <a style="float:right;" href='<?php echo base_url(); ?>inventory/Handover_item/export?user_fk=<?php echo $user;?>&branch_fk=<?php echo $branch;?>' class="btn btn-primary btn-sm" ><i class="fa fa-download" ></i><strong > Export To CSV</strong></a>
                    </div><!-- /.box-header -->
                    ...
                    <div class="box-body">
                        ...
                        <a class="btn btn-primary" href="<?= base_url() . "inventory/handover_item/index"; ?>">Reset</a><br><br>
                                    ...
                                    foreach ($query as $row) { 
                                        ...
                                        <tr>  <td><?php echo $cnt; ?></td>
                                            ...
                                            <td><?php echo ucwords($row['branch_name']); ?></td>
                                             <td><?php echo ucwords($row['handover_branch_name'][0]['branch_name']); ?></td>
                                            <td><?php echo ucwords($row['reagent_name']); ?></td>
                                            <td><?php echo ucwords($row['Batch']); ?></td>
<!--                                            <td><?php echo $row['Quantity'];?></td>-->
                                            <td><?php echo $row['asIUQuantity'];?></td>
                                            <td><?php echo date("d-m-Y", strtotime($row["creteddate"]));?></td>
