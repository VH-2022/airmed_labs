...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Stationary Item List<small></small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>Dashboard"><i class="fa fa-dashboard"></i>Dashboard</a></li>

            <li><i class="fa fa-users"></i>Stationary List</li>
        </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Stationary Item List</h3>
                        <a style="float:right;" href='<?php echo base_url(); ?>inventory/Stationary_master/add' class="btn btn-primary btn-sm" ><i class="fa fa-plus-circle" ></i><strong > Stationary Add</strong></a>
                    ...
                    <div class="box-body">
                        ...
                        <?php echo form_open('inventory/Stationary_master/stationary_list', $attributes); ?>
                        <div class="col-md-2">
                            <input type="text" class="form-control" name="search" placeholder="search" value="<?php echo $item_name; ?>"/>
                        </div>
                         <div class="col-md-2">
                                ...
                                <tbody>
                                    ...
                                    foreach ($query as $row) {
                                        ...
                                        <tr> <td><?php echo $cnt; ?></td>
                                            ...
                                            <td><a href='<?php echo base_url(); ?>inventory/Stationary_master/stationary_edit/<?php echo $row['id']; ?>' data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-edit"></i></a> 
                                                <a style="margin-left:12px" href='<?php echo base_url(); ?>inventory/Stationary_master/stationary_delete/<?php echo $row['id']; ?>' data-toggle="tooltip" data-original-title="Remove" onclick="return confirm('Are you sure you want to remove this data?');"><i class="fa fa-trash-o"></i></a>      
                                            </td>
                                        </tr>
                                        <?php $cnt++; ?>
                                    <?php }if (empty($query)) {
