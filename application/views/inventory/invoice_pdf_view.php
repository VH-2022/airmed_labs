                            ...
                            <tr>
                                ...
                                <td colspan="2" style="text-align:right;">
                                    <div style="float:right;background:#E20025;">
                                        <img class="set_logo" src="https://www.airmedlabs.com/user_assets/images/logo1.png" style="width:170px;padding:10px;float:right;" />
                                    </div>
                                </td>
                            </tr>
                        </table>
...
<th class="txt_align_lft brdr_btm brdr_rgt" style="width:100px;padding:5px;">LOT NO</th>							 
					...
					<?php 
						...
						<td class="brdr_btm brdr_rgt" style="padding:5px;" ><?= $row["lotno"]; ?></td>
						...
						<tr>
						<td class="brdr_btm brdr_rgt" style="padding:5px;" colspan="9"></td>
