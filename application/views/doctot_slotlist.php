...
<div class="full_bg" style="display:none;" id="loader_div">
    ...
    <section class="content-header">
        <h1>
           <?= ucwords($doctotinfo->full_name); ?>  Doctor slot
            <small></small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>Dashboard"><i class="fa fa-dashboard"></i>Dashboard</a></li>
            <li><a href="<?php echo base_url()."Doctor_timslot/index/".$doctotinfo->id; ?>"> <?= ucwords($doctotinfo->full_name); ?> Doctor slot</a></li>
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title"> <?= ucwords($doctotinfo->full_name); ?> Doctor slot</h3>
...
var doctor="<?= $doctotinfo->id; ?>";
$.ajax({  url: '<?php echo base_url(); ?>doctor_timslot/slotupdate',
                type: 'POST',
                data: {doctorfk:doctor,stotalbook:stotalbook,dslot:unchecked},
                success: function (data) {
					 if(data='1'){ $("#sucessmsg").html('<div class="alert alert-success alert-dismissable" id=""  ><button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>Successfully update doctor slot</div>');$("html, body").animate({
            scrollTop: 0
        }, 600);
        }
$("#loader_div").hide();					 
