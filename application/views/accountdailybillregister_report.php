...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
          AccountWise Daily Bill Register
            <small></small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>Dashboard"><i class="fa fa-dashboard"></i>Dashboard</a></li>
            <li><a href="<?php echo base_url()."accountdailybillregister_report/report"; ?>"><i class="fa fa-users"></i>AccountWise Bill Register</a></li>
...
$credtejobuser=$this->input->get('credtejobuser');
 ...
 ?>
   ...
   <?php  echo form_open("accountdailybillregister_report/report", array("method" => "GET", "role" => "form","class"=>'form-horizontal',"id"=>'reportform' )); ?>
	...
	<div class="form-group">
					...
					<div class="form-group">
                      <label class="control-label col-sm-2" for="exampleInputEmail1">Select Branch<span style="color:red">*</span></label>
					  <div class="col-sm-4">
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        <input type="submit" name="search" class="btn btn-success" value="Search" />
		 <a href="<?= base_url()."accountdailybillregister_report/report"; ?>" class="btn btn-primary">Reset</a>
      </div>
                                ...
                                <table id="example4" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
									   ...
									   foreach($query as $row){ $count++; 
										...
										if(! in_array($row->branch_fk,$brancharra)){
											
											if($count != 1){ ?>
										<tr style="border-top: 3px solid black;">
                                                    <td colspan="5"><b>Total for <?= $lastbranch ?> <?php if($start_date != ""){ echo date("d/m/Y",strtotime($start_date)); }else{ echo "-"; } if($end_date != ""){ echo "- ".date("d/m/Y",strtotime($end_date));  } ?></b></td>
									   ...
									   $brantotaldue=0;
										...
										?>
										<tr>
										<td colspan="8"><b>Account Name : <?= ucwords($row->branch_name); ?></b></td>
										</tr>
										<?php 	 } ?>
									  <tr>
									  <td><?= $count; ?></td>
                    ...
                    foreach ($key3["test"] as $kt_key) {
                        ...
                        if (!in_array($kt_key["test_fk"], $test_list)) {
                            ...
                            $test_list[] = $kt_key["test_fk"];
									  ...
									  $totalpaid +=$paid;
									  $totaldue +=$due;
									  $brancharra[]=$row->branch_fk;
									$lastbranch=ucwords($row->branch_name);
...
<?php }else{ ?>
	<tr style="border-top: 3px solid black;">
										...
										<tr>
                                                    <td colspan="4"><b>Total for Patient Count:<?= $count; ?></b></td>
...
<script  type="text/javascript">
		...
		if(len == ""){ $("#brancherror").html("The Branch Name field is required."); } 
		e.preventDefault(); }
        ...
        .on('changeDate', function (selected) {
            ...
            $('#startdate').datepicker('setEndDate', minDate);
														 ...
														 $("#reportcsv").click(function(){
															 location.href = '<?= base_url()."accountdailybillregister_report/report_exportcsv?" ?>'+$("#reportform").serialize();
