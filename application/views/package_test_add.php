...
<section class="content-header">
    <h1>
        Add Package For <?=ucfirst($package_info[0]["title"]);?>
        <small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo base_url(); ?>home"><i class="fa fa-dashboard"></i>Dashboard</a></li>
        <li><a href="<?php echo base_url(); ?>package_master/package_list">Package List</a></li>
        <li class="active">Add Package Test</li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <p class="help-block" style="color:red;"><?php
                    ...
                    ?></p>
                <!-- form start -->
                <form role="form" action="<?php echo base_url(); ?>package_master/package_test_add/<?= $pid ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        <div class="col-md-6">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php foreach($package_test as $key){ ?>
                                    <tr>
                                        <td><?=ucfirst($key["test_name"]);?></td>
                                        <td><a href="<?=base_url();?>package_master/package_test_delete/<?= $pid ?>/<?=$key["id"]?>" onclick="confirm('Are you sure?');">Delete</a></td>
                                    </tr> 
                                    <?php } ?>
                                    <?php if(empty($package_test)){ ?>
