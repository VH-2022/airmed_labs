...
<section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <?php  /* <li><a href="<?php echo base_url(); ?>Branch_Master/Branch_list"><i class="fa fa-users"></i>Branch List</a></li> */ ?>
        <li class="active">Party ledger Add</li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-6">
                        <!-- form start -->
                        <form role="form" action="<?php echo base_url()."branch_receive_payment/party_add"; ?>" method="post" >

                            <div class="form-group">
                                <label for="type">Party name</label><span style="color:red">*</span>
								<input type="text" name="partyname" class="form-control" value="<?= set_value("partyname"); ?>" />
