    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" action="<?php echo base_url(); ?>Callreason_master/edit/<?php echo $query[0]['id'] ?>" method="post">
                    ...
                    <div class="box-body">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  id="reason" name="reason" class="form-control"  value="<?php echo $query[0]['reason']; ?>"/>
                            </div>
