    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" action="<?php echo base_url(); ?>doctor_master/doctor_add" method="post" id="formid" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="exampleInputFile">Sales Person</label>
                                <select name="ref_id" class="form-group">
                                    <option value="">Select Sales</option>
                                    <?php foreach ($sales_person as $sales) { ?>
