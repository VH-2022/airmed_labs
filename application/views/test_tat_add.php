...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Add Test TAT</li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="col-md-6">
                        <!-- form start -->
                        <form role="form" action="<?php echo base_url(); ?>Test_tat_master/add" method="post" enctype="multipart/form-data" id="branch_form">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control chosen-select"  name="test" id="test">
                                    ...
                                    foreach ($test_list as $row) {
                                        ?>
                                        <option type="1" value="<?php echo $row->id; ?>"><?php echo ucwords($row->test_name); ?></option>
                                    <?php } ?>
                                    <?php
                                    foreach ($package_list as $row) {
                                        ?>
                                        <option type="2" value="<?php echo $row->id; ?>"><?php echo ucwords($row->title); ?></option>
                                    <?php } ?>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  name="tat" class="form-control" id="tat" placeholder="TAT" value="<?php echo set_value('tat'); ?>">
