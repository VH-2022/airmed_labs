    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" action="<?php echo base_url(); ?>parameter_master/parameter_add" id="par_submit" method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="par_name" name="par_name" class="form-control" placeholder="Parameter Name">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="par_range_minimum" name="par_range_minimum" class="form-control" placeholder="Minimun Range">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="par_range_maximum" name="par_range_maximum" class="form-control" placeholder="Maximum Range">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="par_unit" name="par_unit" class="form-control" placeholder="Parameter Unit">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="chosen" name="group_name" id="group_name">
                                        ...
                                        <?php foreach ($parameter_list as $parameter) { ?>
                                            <option value="<?php echo $parameter["id"] ?>"><?php echo ucfirst($parameter["parameter_name"]); ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                    ...
                    <div class="box-footer">
                        <div class="col-md-6">
                            <button class="btn btn-primary" type="button" onclick="add_parameter();"><i class="fa fa-plus-circle"></i>Add</button>
                    ...
                    setTimeout(function () {
                        $.ajax({
                            ...
                            success: function (data) {
                                if (data > 0) {
                                    $("#success_msg").html("Parameter Successfully Added");
