                    ...
                    <div class="box-body">
                        <div class="col-md-6">
                            ...
                            <?php foreach ($citys as $key) { ?>
                                <div class="form-group">
                                    <label for="exampleInputFile"><?= ucfirst($key["name"]); ?> Price</label>
                                    <input type="text"  name="aprice[]" class="form-control"  value="">
                                    <input type="hidden" name="city[]" value="<?= $key["id"] ?>"/>
                                    <span style="color: red;"><?= form_error('aprice[]'); ?></span>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputFile"><?= ucfirst($key["name"]); ?> Discount Price</label>
                                    <input type="text"  name="dprice[]" class="form-control"  value="" >
