...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Edit Advertisement Edit</li>
    </ol>
</section>
                ...
                <div class="box-body">
                    <div class="col-md-6">
                            ...
                            $id =$view_data->id;
                        {
                            ...
                            <!-- form start -->
                            <?php
                            echo form_open_multipart('adver_master/adver_edit/' . $id . '', ['method' => 'post', 'class' => 'form-horizontal',
                                'id' => 'target', 'enctype' => 'multipart/form-data']);
                            ?>
                            <div class="form-group">
                                <label for="name">Advertisement Title<span style="color:red;">*</span></label>
                                <?php
