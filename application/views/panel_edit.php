    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" action="<?php echo base_url(); ?>Test_panel/panel_edit/<?php echo $query->id ;?>" method="post" enctype="multipart/form-data">

                      <div class="box-body">
                        <div class="col-md-6">
                           <div class="form-group">
                                <label for="exampleInputFile">Test Panel Name</label><span style="color:red">*</span>
                                <input type="text"  name="name" class="form-control"  placeholder ="Test Panel Name" value="<?php echo $query->name;?>" >
