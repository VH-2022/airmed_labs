...
<script src="<?php echo base_url(); ?>plugins/jQuery/jQuery-2.1.4.min.js"></script>
          ...
          <section class="content">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" action="<?php echo base_url(); ?>location-master/state-edit/<?=$cid?>" method="post" enctype="multipart/form-data">
                  ...
                  <div class="box-body">
                    <div class="col-md-6">
                      ...
                      <input type="text"  name="name" class="form-control"  value="<?php echo $query[0]["state_name"]; ?>" >
