...
<div class="content-wrapper" style="margin-top:20px;">
                ...
                <div class="box box-primary">
                    <div class="nav-tabs-custom">
                        <ul class="nav md-pills nav-justified pills-secondary">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo base_url() ?>Phlebo_master_punchin_punchout/index?phlebo_name=<?php echo $_GET['phlebo_name'] ?>&search=Search" role="tab">Phlebotomy Punch In/Out Report</a>
                            </li>
                            <!--                            <li class="nav-item">
                ...
                <div class="col-xs-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <!-- Search start-->
                            <?php echo form_open("Phlebo_master_added_jobs", array("method" => "GET", "role" => "form")); ?>
                            <div class="row">
                                <div class="col-sm-2">
                                ...
                                */?>
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <?php /* if ($start_date != '' || $end_date != '' || $phlebo != '' || $city != '' || $s_collect != '') { ?>
                                        <a href="<?php echo base_url(); ?>Phlebo_master_added_jobs/export?start_date=<?php echo $start_date; ?>&end_date=<?php echo $end_date; ?>&city=<?php echo $city; ?>&phlebo=<?php echo $phlebo; ?>&sample_collect=<?php echo $s_collect; ?>" class="btn btn-primary">Export</a><?php } */?>
                                </div>
                            </div>
                            <br>
                            <?php echo form_close(); ?>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($view_report as $am_br) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="<?php echo base_url(); ?>job-master/job-details/<?php echo $am_br['id']; ?>" target="_blank"><?php echo $am_br['id'] . '&nbsp;(' . $am_br['order_id'] . ')'; ?>  
                                                        </td>
    ...
    <script type="text/javascript">
        ...
        function get_branch1() {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>Phlebo_master_added_jobs/getPhleboName',
                type: 'post',
