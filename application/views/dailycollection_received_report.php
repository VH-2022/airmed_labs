            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <!-- Search start-->
                        <?php echo form_open("Dailyreport_master/job_received", array("method" => "GET", "role" => "form")); ?>
                        <div class="row">
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-3">
                                ...
                                <?php if ($start_date != '' || $end_date != '' || $branch != '') { ?>
                                    <a href="<?php echo base_url(); ?>dailyreport_master/export_csv_new?start_date=<?php echo $start_date; ?>&end_date=<?php echo $end_date; ?>&branch=<?php echo $branch; ?>&payment=<?php echo $payment; ?>&report=<?php echo $report; ?>" class="btn-sm btn-primary">Export</a><?php } ?>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10 col-sm-10 pdng_0" style="margin-bottom:10px;">
                                        ...
                                        <label class="radio-inline"><input type="radio" value="CASH" <?php if($payment=='CASH'){ echo " checked='checked'"; } ?> name="payment">Cash</label>
                                        <label class="radio-inline"><input type="radio" value="CHEQUE" <?php if($payment=='CHEQUE'){ echo " checked='checked'"; } ?> name="payment">Cheque</label>
                                        <label class="radio-inline"><input type="radio" value="CREDIT CARD" <?php if($payment=='CREDIT CARD'){ echo " checked='checked'"; } ?> name="payment">Credit Card</label>
                                        <label class="radio-inline"><input type="radio" value="wallet" <?php if($payment=='wallet'){ echo " checked='checked'"; } ?> name="payment">Wallet </label>
                                        <label class="radio-inline"><input type="radio" value="payumoney" <?php if($payment=='payumoney'){ echo " checked='checked'"; } ?> name="payment">Payumoney</label>
                                        <label class="radio-inline"><input type="radio" value="CREDITORS" <?php if($payment=='CREDITORS'){ echo " checked='checked'"; } ?> name="payment">Creditor</label>
                                        <label class="radio-inline"><input type="radio" value="all" <?php if($payment=='all'){ echo "  checked='checked'"; } ?> <?php if($payment==''){ echo "  checked='checked'"; } ?> name="payment">All</label>  
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-10 col-sm-10 pdng_0" style="margin-bottom:10px;">
                                        ...
                                        <label class="radio-inline"><input type="radio" <?php if($report=='summery'){ echo " checked='checked'"; } ?> value="summery" name="report">Summary</label>
                                        <label class="radio-inline"><input type="radio" <?php if($report=='details'){ echo " checked='checked'"; } ?> <?php if(empty($report)){ echo " checked='checked'"; } ?> value="details" name="report">Details</label>
										<!--<label class="radio-inline"><input type="radio" <?php if($report=='branchsummery'){ echo " checked='checked'"; } ?> value="branchsummery" name="report">Branch Wise Summary</label> -->
                                    </div> 
                                </div>
