                    ...
                    <div id="otp_div" style="display:none;">
                        <div class="form-group has-feedback">
                            <div class="input-group">
                                ...
                                <input type="password"  placeholder="OTP" id="otp_val" class="form-control" name="otp">
                            </div>
                                ...
                                function countdown(elementName, minutes, seconds)
                                {
                                    ...
                                    function updateTimer()
                                    {
                                        ...
                                        if (msLeft < 1000) {
                                            ...
                                            element.innerHTML = 'Resend Master OTP after <b>' + (hours ? hours + ':' + twoDigits(mins) : mins) + ':' + twoDigits(time.getUTCSeconds()) + ' </b> second';
...
//end new counter
                                ...
                                function onTimer() {
                                    $("#resend_opt").attr("style", "display:none;");
                                    if (i < 2) {
                                        document.getElementById('mycounter').innerHTML = "Resend Master OTP after <b>" + i + " Second</b>";
                                    } else {
                                        document.getElementById('mycounter').innerHTML = "Resend Master OTP after <b>" + i + " Seconds</b>";
                                    }
                                    i--;
                                    if (i < 0) {
                                        $("#mycounter").attr("style", "display:none;");
                                ...
                                function check_admin_login(login_type) {
                                    ecnt = 0;
                                    $("#error_email").html("");
                                    $("#error_password").html("");
                                    $("#success_msg").html("");
                                    ...
                                    $.ajax({
                                        ...
                                        data: {
                                            email: email, password: password, type: login_type
                                        },
                                        type: "POST",
                                        beforeSend: function () {
                                                ...
                                                setTimeout(function () {
                                                    window.location = '<?= base_url() ?>Dashboard?id=<?php echo time(); ?>';
                                                                    ...
                                                                    if (json_data.status == '1') {
                                                                        ...
                                                                        $("#success_msg").html('<div class="alert alert-success">Enter your master OTP.</div>');
